...
In accordance with § 33.32(f), a grantee must submit an inventory of all federally owned property (as distinct from property acquired with grant funds) for which it is accountable and request disposition instructions from the Federal agency of property no longer needed.
