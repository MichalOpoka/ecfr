...
(C) 5 U.S.C. 552a(b)(3)—For an authorized Routine Use, *i.e.* the “Routine Use Exception.” The Routine Use must be listed in the applicable system of records notice published in the Federal Register and the purpose of the disclosure must be compatible with the purpose for the published Routine Use.
...
Note 1 to paragraph (h)(3)(iii)(F).

Records transferred to the Federal Records Centers for storage remain under the control of the Department of the Army and no accounting for disclosure is required under the Privacy Act.
