...
![](/graphics/ec28se91.090.gif)where:*I*e = effective intensity (candles).*I(t)* = instantaneous intensity as a function of time.*t*2−*t*l = flash time interval (seconds).Normally, the maximum value of effective intensity is obtained when *t*2 and *t*1 are chosen so that the effective intensity is equal to the instantaneous intensity at *t*2 and *t*1.
