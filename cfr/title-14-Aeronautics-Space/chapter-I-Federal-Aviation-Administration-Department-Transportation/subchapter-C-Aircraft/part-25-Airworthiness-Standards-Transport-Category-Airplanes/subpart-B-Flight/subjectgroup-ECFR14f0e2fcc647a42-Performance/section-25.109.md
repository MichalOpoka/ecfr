...
![](/graphics/er18fe98.004.gif)Where—Tire Pressure = maximum airplane operating tire pressure (psi);μt/gMAX = maximum tire-to-ground braking coefficient;V = airplane true ground speed (knots); andLinear interpolation may be used for tire pressures other than those listed.
...
![](/graphics/er18fe98.005.gif)Where—Tire Pressure = maximum airplane operating tire pressure (psi);μt/gMAX = maximum tire-to-ground braking coefficient;V = airplane true ground speed (knots); andLinear interpolation may be used for tire pressures other than those listed.
