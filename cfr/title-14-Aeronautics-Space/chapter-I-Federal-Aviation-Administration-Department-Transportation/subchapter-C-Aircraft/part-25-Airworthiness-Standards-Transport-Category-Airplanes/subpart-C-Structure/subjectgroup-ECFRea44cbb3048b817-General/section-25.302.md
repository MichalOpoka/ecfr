...
Figure 1 to paragraph (c)(1)(i)![](/graphics/er27au24.002.gif)
...
Figure 2 to paragraph (c)(2)(ii)![](/graphics/er27au24.003.gif)Qj = (Tj)(Pj) where:Tj = Average time spent in failure condition j (in hours)Pj = Probability of occurrence of failure mode j (per hour)If Pj is greater than 10−3 per flight hour, then a 1.5 factor of safety must be applied in lieu of the factor of safety defined in Figure 2.
