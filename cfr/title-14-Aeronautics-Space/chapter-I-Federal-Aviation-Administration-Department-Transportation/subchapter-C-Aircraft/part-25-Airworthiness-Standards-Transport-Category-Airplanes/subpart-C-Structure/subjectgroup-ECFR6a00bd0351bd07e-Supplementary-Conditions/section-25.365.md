...
Ho = PAswhere,Ho = Maximum opening in square feet, need not exceed 20 square feet.P = (As/6240) + .024As = Maximum cross-sectional area of the pressurized shell normal to the longitudinal axis, in square feet; and
