...
(1) *FRM.* The type certificate holder must submit for approval by the FAA Oversight Office design changes and service instructions for installation of fuel tank flammability reduction means (FRM) meeting the criteria of paragraph (c) of this section.

(2) *IMM.* The type certificate holder must submit for approval by the FAA Oversight Office design changes and service instructions for installation of fuel tank IMM that comply with 14 CFR 25.981(c) in effect on December 26, 2008.
...
(g) *Compliance Plan for Flammability Exposure Analysis.* Within 90 days after December 26, 2008, each holder of a type certificate required to comply with paragraph (b) of this section must submit to the FAA Oversight Office a compliance plan consisting of the following:
...
(h) *Compliance Plan for Design Changes and Service Instructions.* Within 210 days after December 26, 2008, each holder of a type certificate required to comply with paragraph (d) of this section must submit to the FAA Oversight Office a compliance plan consisting of the following:
...
(3) A proposal for submitting a draft of all compliance items required by paragraphs (d), (e) and (f) of this section for review by the FAA Oversight Office not less than 60 days before the compliance times specified in those paragraphs.
