...
(c) The foundation label required in paragraph (a) of this section must measure 23/4″ in width and the length can increase as needed for varying information. The label must be white with black text. The label shall contain the following:
