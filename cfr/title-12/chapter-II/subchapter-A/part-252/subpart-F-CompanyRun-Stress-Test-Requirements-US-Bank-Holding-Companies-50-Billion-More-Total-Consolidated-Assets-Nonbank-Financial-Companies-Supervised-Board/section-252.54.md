...
(2) *Additional components.* (i) The Board may require a covered company with significant trading activity, as determined by the Board and specified in the Capital Assessments and Stress Testing report (FR Y-14), to include a trading and counterparty component in its adverse and severely adverse scenarios in the stress test required by this section:
...
(iii) *Description of component.* The Board will respond in writing within 14 calendar days of receipt of the company's request. The Board will provide the covered company with a description of any additional component(s) or additional scenario(s) by March 1 of the calendar year in which the stress test is performed pursuant to this section.
