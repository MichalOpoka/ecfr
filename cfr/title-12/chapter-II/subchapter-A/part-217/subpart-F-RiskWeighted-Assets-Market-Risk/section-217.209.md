...
(a) *General requirement.* (1) Subject to the prior approval of the Board, a Board-regulated institution may use the method in this section to measure comprehensive risk, that is, all price risk, for one or more portfolios of correlation trading positions.
...
(c) *Requirements for stress testing.* (1) A Board-regulated institution must at least weekly apply specific, supervisory stress scenarios to its portfolio of correlation trading positions that capture changes in:
...
(2) *Other requirements.* (i) A Board-regulated institution must retain and make available to the Board the results of the supervisory stress testing, including comparisons with the capital requirements generated by the Board-regulated institution's comprehensive risk model.
