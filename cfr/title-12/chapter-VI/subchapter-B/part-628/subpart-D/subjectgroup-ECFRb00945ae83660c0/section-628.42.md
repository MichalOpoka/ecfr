...
(i) *N*th*-to-default credit derivatives*—(1) *Protection provider.* A System institution must assign a risk weight to an nth-to-default credit derivative in accordance with FCA guidance.
