...
(iii) For repo-style transactions and client-facing derivative transactions, a national bank or Federal savings association may multiply the standard supervisory haircuts provided in paragraphs (c)(3)(i) and (ii) of this section by the square root of 1/2 (which equals 0.707107). For client-facing derivative transactions, if a larger scaling factor is applied under § 3.34(f), the same factor must be used to adjust the supervisory haircuts.
