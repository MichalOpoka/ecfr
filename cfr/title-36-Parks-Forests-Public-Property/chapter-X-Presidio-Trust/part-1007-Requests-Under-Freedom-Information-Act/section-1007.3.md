...
(A) Specify the fee category (commercial use, educational institution, noncommercial scientific institution, news media, or other, as defined in § 1007.9 of this chapter) in which the requester claims the request falls and the basis of this claim; and

(B) State the maximum amount of fees that the requester is willing to pay or include a request for a fee waiver.

(ii) Requesters are advised that, under § 1007.9 (f), (g) and (h), the time for responding to requests may be delayed:
