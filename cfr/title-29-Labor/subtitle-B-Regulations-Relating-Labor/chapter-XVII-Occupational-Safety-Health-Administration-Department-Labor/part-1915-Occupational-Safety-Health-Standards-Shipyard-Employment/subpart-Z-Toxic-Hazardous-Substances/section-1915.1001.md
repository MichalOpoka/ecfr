...
WEAR RESPIRATORY PROTECTIONAND PROTECTIVE CLOTHING IN THIS AREA
...
fiberglassanhydrateplant fibersperlite veinsgypsumsome synthetic fibersmembrane structuressponge spiculesdiatomsmicroorganismwollastonite
...
![](/graphics/er10au94.028.gif)7.3. Recount Calculations
...
CV = antilog10[0.182205(log10 (x))2−0.973343(log 10(x)) + 0.327499]Sampling Pump Flow Rate Corrections
...
![](/graphics/er10au94.031.gif)

Example: If PL = 108 µm, AL = 2.93 mm and D = 100 µm, then,

![](/graphics/er10au94.032.gif)
