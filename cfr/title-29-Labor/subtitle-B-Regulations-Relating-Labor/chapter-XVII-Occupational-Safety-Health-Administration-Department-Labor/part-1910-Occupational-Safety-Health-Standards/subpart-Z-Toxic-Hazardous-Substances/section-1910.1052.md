...
*Methylene chloride* (MC) means an organic compound with chemical formula, CH2 Cl2. Its Chemical Abstracts Service Registry Number is 75-09-2. Its molecular weight is 84.9 g/mole.
...
This section addresses MC exposure in marine terminal and longshore employment only where leaking or broken packages allow MC exposure that is not addressed through compliance with 29 CFR parts 1917 and 1918, respectively.
...
E. Your employer is required to provide labels and safety data sheets (SDSs) for all materials, mixtures or solutions composed of greater than 0.1 percent MC. These materials, mixtures or solutions would be classified and labeled in accordance with § 1910.1200.
