...
(2) The opening in the table shall be kept as small as possible. The clearance between the edge of the rear table and the cutter head shall be not more than one-eighth inch. The table throat opening shall be not more than 21/2 inches when tables are set or aligned with each other for zero cut.
