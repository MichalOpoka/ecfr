...
(r) *Gray and white bins.* On new installations guard rails conforming to § 1910.23 shall be provided where workers are required to plait by hand from the top of the bin so as to protect the worker from falling to a lower level.
