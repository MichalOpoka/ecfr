...
(c) *Test procedures - general.* (1) The requirements of 29 CFR 1926.1002(d), (e), and (f) shall be met.
...
(d) *Drop test procedures.* (1) The same frame shall be subjected to the drop test following either the static or dynamic test.
...
(e) *Crush test procedure.* (1) The same frame shall be subjected to the crush test following the drop test and static or dynamic test.
...
(f) *Performance requirements* - (1) *General.* The performance requirements set forth in 29 CFR 1926.1002(i)(2), (3), and (4) shall be met.

(2) *Drop test performance requirements.* (i) Instantaneous deformation due to impact of the sphere shall not enter the protected zone as illustrated in Figures W-25, W-26, and W-28.

(ii) In addition to the dimensions set forth in 29 CFR 1926.1002(i)(1)(i), the following dimensions apply to Figure W-28:

*H* = 17.5 in. (444 mm); and*J* = 2 in. (50.8 mm), measured from the outer periphery of the steering wheel.
