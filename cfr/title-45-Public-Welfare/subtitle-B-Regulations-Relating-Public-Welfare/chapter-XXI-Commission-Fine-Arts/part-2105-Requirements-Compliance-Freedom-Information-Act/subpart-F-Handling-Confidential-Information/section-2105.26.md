...
(a) Either a copy of the request, the exact language of the request, or (for notices published under § 2105.25(b)) a general description of the request;
...
(i) Except as outlined in § 2105.27, an Agency must promptly notify a submitter in writing when it receives a FOIA request if:
