...
(a) Generally, you may choose the form or format of disclosure for records requested. The Agency must provide the records in the requested form or format if the Agency can readily reproduce the record in that form or format. If the Agency cannot readily reproduce the record in that form or format, it must explain why it cannot.
