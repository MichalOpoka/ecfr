...
(c) *What happens if CNCS rejects an application?* CNCS will return an application that is not approved for funding to the applicant with an explanation of CNCS' decision.

(d) *For what period of time does CNCS award a grant?* CNCS awards a Foster Grandparent grant for a specified period that is usually three years in duration.
