...
(3) *50 percent CCF.* An Enterprise must apply a 50 percent CCF to the amount of commitments with an original maturity of more than one year that are not unconditionally cancelable by the Enterprise.
