...
|-----------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|------------------------------------------------------------------|----|---|----|----|----|
|               Sovereign issuers risk weight under § 1240.32 <sup>2</sup>  <br/>(in percent)               |  Non-sovereign issuers risk weight under § 1240.32  <br/>(in percent)  |                                                                  |    |   |    |    |    |
...
(C) For repo-style transactions and client-facing derivative transactions, an Enterprise may multiply the supervisory haircuts provided in paragraphs (b)(2)(ii)(A) and (B) of this section by the square root of1/2 (which equals 0.707107). If the Enterprise determines that a longer holding period is appropriate for client-facing derivative transactions, then it must use a larger scaling factor to adjust for the longer holding period pursuant to paragraph (b)(2)(ii)(F) of this section.
...
(*2*) The minimum holding period for a repo-style transaction is five business days and for an eligible margin loan is ten business days except for transactions or netting sets for which paragraph (b)(2)(iii)(A)(*3*) of this section applies. When an Enterprise calculates an own-estimates haircut on a TN-day holding period, which is different from the minimum holding period for the transaction type, the applicable haircut (HM) is calculated using the following square root of time formula:

![](/graphics/er30no23.044.gif)Where:(*i*) TM equals 5 for repo-style transactions and 10 for eligible margin loans;(*ii*) TN equals the holding period used by the Enterprise to derive HN; and(*iii*) HN equals the haircut based on the holding period TN
...
[88 FR 83481, Nov. 30, 2023]Risk-Weighted Assets for Unsettled Transactions