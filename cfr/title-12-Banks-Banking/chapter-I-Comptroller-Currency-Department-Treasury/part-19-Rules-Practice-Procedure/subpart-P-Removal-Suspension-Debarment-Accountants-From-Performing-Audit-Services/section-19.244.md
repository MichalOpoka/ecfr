...
(b) Upon written request, the Comptroller, for good cause shown, may grant written permission to such accountant or firm to perform audit services for national banks. The request shall contain a concise statement of the action requested. The Comptroller may require the applicant to submit additional information.