...
![](/graphics/er11oc13.050.gif)where EADi represents the EAD associated with the ith instrument in the underlying exposures.
...
![](/graphics/er11oc13.051.gif)where LGDi represents the average LGD associated with all exposures to the ith obligor. In the case of a resecuritization, an LGD of 100 percent must be assumed for the underlying exposures that are themselves securitization exposures.
...
![](/graphics/er11oc13.052.gif)where:
