...
(c) *Plans in general* - (1) *Term.* A plan may have a term of no more than five years, and any multi-year plan must include annual interim measurable goals under which the appropriate Federal banking agency will evaluate the savings association's performance.
