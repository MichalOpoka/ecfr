...
(i) The flier fails to file all required publicly available information on a timely basis to permit review by interested persons or makes a request for confidential treatment not granted by the OCC that delays the public availability of that information;
