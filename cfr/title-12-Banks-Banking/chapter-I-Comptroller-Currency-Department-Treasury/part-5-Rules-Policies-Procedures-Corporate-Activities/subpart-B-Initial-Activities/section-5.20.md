...
(7) *Fiduciary powers.* The business plan or operating plan must indicate if the proposed institution intends to exercise fiduciary powers. The information required by § 5.26 shall be filed with the charter application. A separate application is not required.
