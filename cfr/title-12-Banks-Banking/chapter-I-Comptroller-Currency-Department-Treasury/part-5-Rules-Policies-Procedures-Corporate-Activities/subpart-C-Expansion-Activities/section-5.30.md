...
(f) *Procedures* - (1) *In general.* Except as provided in paragraph (f)(2) of this section, each national bank proposing to establish a branch shall submit to the appropriate OCC licensing office a separate application for each proposed branch.
