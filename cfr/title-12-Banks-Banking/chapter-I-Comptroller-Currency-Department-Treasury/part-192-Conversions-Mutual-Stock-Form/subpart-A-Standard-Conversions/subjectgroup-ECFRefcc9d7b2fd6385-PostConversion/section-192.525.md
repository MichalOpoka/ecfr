...
(5) An acquiror does not have to file a separate application to obtain the appropriate Federal banking agency's approval under paragraph (a) of this section, if the acquiror files an application under § 5.50 of this chapter that specifically addresses the criteria listed under paragraph (d) of this section and you do not oppose the proposed acquisition.
