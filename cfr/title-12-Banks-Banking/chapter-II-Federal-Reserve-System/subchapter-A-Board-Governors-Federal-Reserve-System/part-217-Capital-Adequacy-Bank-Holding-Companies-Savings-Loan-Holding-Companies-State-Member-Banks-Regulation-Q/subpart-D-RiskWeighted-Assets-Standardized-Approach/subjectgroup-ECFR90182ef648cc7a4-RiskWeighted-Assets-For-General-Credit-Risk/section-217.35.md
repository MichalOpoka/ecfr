...
![](/graphics/er11oc13.058.gif)Where:
...
![](/graphics/er11oc13.016.gif)

Subscripts 1 and 2 denote the clearing members with the two largest ANet values. For purposes of this paragraph (d), for derivatives ANet is defined in § 217.34(a)(2)(ii) and for repo-style transactions, ANet means the exposure amount as defined in § 217.37(c)(2) using the methodology in § 217.37(c)(3);
...
![](/graphics/er11oc13.017.gif)Where:

(*1*) DFi = the Board-regulated institution's unfunded commitment to the default fund;
...
(B) For a Board-regulated institution that is a clearing member of a QCCP with a default fund supported by unfunded commitments and is unable to calculate KCM using the methodology described in paragraph (d)(3)(iii) of this section, KCM equals:

![](/graphics/er11oc13.018.gif)Where:
