...
(2) The level 2B cap excess amount; *plus*
...
(h) *Calculation of the adjusted excess HQLA amount.* As of the calculation date, the adjusted excess HQLA amount equals:

(1) The adjusted level 2 cap excess amount; *plus*

(2) The adjusted level 2B cap excess amount; *plus*

(3) The adjusted public sector entity security cap excess amount.

(i) *Calculation of the adjusted level 2 cap excess amount.* As of the calculation date, the adjusted level 2 cap excess amount equals the greater of:
...
(j) *Calculation of the adjusted level 2B excess amount.* As of the calculation date, the adjusted level 2B excess liquid asset amount equals the greater of:
