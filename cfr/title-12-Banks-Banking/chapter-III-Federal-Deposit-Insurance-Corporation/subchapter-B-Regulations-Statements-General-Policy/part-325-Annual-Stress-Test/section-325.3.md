...
(c) *Ceasing to be a covered bank or changing categories.* (1) A covered bank will remain subject to the stress test requirements based on its applicable category unless and until total consolidated assets of the covered bank falls below the relevant size threshold for each of four consecutive quarters as reported on the covered bank's most recent Call Reports. The calculation will be effective on the as-of date of the fourth consecutive Call Report.
