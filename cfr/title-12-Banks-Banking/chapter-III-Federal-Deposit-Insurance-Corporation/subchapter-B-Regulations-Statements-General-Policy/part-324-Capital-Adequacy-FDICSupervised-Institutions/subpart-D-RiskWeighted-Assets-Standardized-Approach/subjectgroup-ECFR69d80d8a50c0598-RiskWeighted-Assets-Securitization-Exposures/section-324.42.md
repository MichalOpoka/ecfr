...
(i) *Nth-to-default credit derivatives* - (1) *Protection provider.* An FDIC-supervised institution may assign a risk weight using the SSFA in § 324.43 to an nth-to-default credit derivative in accordance with this paragraph (i). An FDIC-supervised institution must determine its exposure in the nth-to-default credit derivative as the largest notional amount of all the underlying exposures.
...
(A) If the FDIC-supervised institution purchases credit protection from a counterparty that is not a securitization SPE, the FDIC-supervised institution must determine the risk weight for the exposure according to general risk weights under § 324.32.
