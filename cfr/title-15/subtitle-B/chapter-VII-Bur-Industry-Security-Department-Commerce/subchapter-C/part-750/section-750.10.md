...
The undersigned hereby certifies that, if license number(s) \_\_\_\_\_\_ is (are) transferred in accordance with my (our) request, any and all documents evidencing the order covered by this (these) license(s) will be retained and made available upon request in compliance with the recordkeeping provisions contained in Part 762 of the Export Administration Regulations. The undersigned further certifies compliance with all requirements of the Export Administration Regulations regarding these licenses.
