...
(A) Where the food that bears the claim meets the requirements of paragraphs (d)(2)(vi) or (d)(2)(vii) of this section based on its reference amount customarily consumed, and the labeled serving size differs from that amount, the claim shall be followed by a statement explaining that the claim is based on the reference amount rather than the labeled serving size (e.g., “Diets low in sodium may reduce the risk of high blood pressure, a disease associated with many factors. A serving of \_\_ ounces of this product conforms to such a diet.”).
