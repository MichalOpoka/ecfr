...
|----------|---------------------------------------------------------------------------|
|Sulfolane |Not to exceed 0.15 percent as residual solvent in the finished basic resin.|
...
In testing the finished polyarylsulfone resin use a separate test sample for each required extracting solvent.
