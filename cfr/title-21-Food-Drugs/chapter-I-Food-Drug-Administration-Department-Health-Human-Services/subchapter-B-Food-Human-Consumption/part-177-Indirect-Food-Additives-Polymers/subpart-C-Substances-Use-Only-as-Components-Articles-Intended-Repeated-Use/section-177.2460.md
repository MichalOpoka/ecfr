...
|List of substances|Limitations (expressed as percent by weight of finished basic resin)|
|------------------|--------------------------------------------------------------------|
...
![](/graphics/er01ja93.406.gif)where:*t* = Solution efflux time.*t*o = Solvent efflux time.*c* = Concentration of solution in terms of grams per deciliter.
