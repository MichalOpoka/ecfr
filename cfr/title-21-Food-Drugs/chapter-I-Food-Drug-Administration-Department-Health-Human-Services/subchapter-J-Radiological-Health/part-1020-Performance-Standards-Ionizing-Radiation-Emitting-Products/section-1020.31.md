...
For X-ray Field Limitation System FailureThe override capability is considered accessible to the operator if it is referenced in the operator's manual or in other material intended for the operator or if its location is such that the operator would consider it part of the operational controls.
