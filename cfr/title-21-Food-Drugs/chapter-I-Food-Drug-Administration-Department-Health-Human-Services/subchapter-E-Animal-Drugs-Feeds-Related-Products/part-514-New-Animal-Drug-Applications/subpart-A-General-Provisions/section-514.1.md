...
(1) *Identification.* Whether the submission is an original or supplemental application; the name and the address of the applicant; the date of the application; the trade name(s) (if one has been proposed) and chemical name(s) of the new animal drug. Upon receipt, the application will be assigned a number NADA \_\_, which shall be used for all correspondence with respect to the application.
