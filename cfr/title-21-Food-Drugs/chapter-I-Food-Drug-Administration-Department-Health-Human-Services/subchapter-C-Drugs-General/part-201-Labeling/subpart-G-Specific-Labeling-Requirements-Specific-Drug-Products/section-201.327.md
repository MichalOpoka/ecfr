...
|                                        Wavelength range (nm)                                         |Percent erythemal contribution <sup>1</sup>|
|------------------------------------------------------------------------------------------------------|-------------------------------------------|
|                                                \<290                                                 |                   \<0.1                   |
|                                               290-300                                                |                  1.0-8.0                  |
|                                               290-310                                                |                 49.0-65.0                 |
...
|                                               290-340                                                |                 94.0-97.0                 |
|                                               290-400                                                |                99.9-100.0                 |
|<sup>1</sup> Calculation of erythema action spectrum described in § 201.327(i)(1)(ii) of this section.|                                           |
...
|                  Benzyl alcohol                   |      0.50       |
|                      Part D:                      |                 |
|                Purified water USP                 | QS <sup>1</sup> |
|<sup>1</sup> Quantity sufficient to make 100 grams.|                 |
...
![](/graphics/er17jn11.003.gif)Where to = retention time for oxybenzonetp = retention time for padimate OWo = oxybenzone peak width at baselineWp = padimate O peak width at baselineIf the resolution (R) is less than 3.0, adjust the mobile phase or replace the column.
...
(3) *Sunscreen product pre-irradiation.* To account for lack of photostability, apply the sunscreen product to the PMMA plate as described in paragraph (b) of this section and then irradiate with a solar simulator described in section 352.70(b) of this chapter. The irradiation dose should be 4 MEDs which is equivalent to an erythemal effective dose of 800 J/m2 (*i.e.,* 800 J/m2-eff).
...
![](/graphics/er17jn11.010.gif)is the ratio of the mean of the C(λ) values to the mean of the P(λ) values, as follows:![](/graphics/er17jn11.006.gif)Where n ≥5
...
![](/graphics/er17jn11.007.gif)Where λc = critical wavelengthA(λ) = mean absorbance at each wavelengthdλ = wavelength interval between measurementsA mean critical wavelength of 370 nm or greater is classified as broad spectrum protection.[76 FR 35660, June 17, 2011, as amended at 76 FR 38975, July 5, 2011]