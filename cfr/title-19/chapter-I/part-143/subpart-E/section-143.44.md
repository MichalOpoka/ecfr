...
(c) *Automation requirements.* Only those entries and entry summaries that CBP processes completely in an electronic data interchange system will be accepted for RLF. For a listing of entry types that may be filed via RLF, go to *http://www.cbp.gov/xp/cgov/trade/trade\_programs/remote\_location\_filing/.*
