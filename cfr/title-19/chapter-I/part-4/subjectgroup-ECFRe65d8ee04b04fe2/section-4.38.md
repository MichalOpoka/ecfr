...
![](/graphics/ec14no91.167.gif)The pickup order shall contain a duly authenticated customhouse broker's signature, unless it is presented by a person properly identified as an employee or agent of the ultimate consignee. When delivered quantities are verified by a Customs officer, he shall certify all copies of the pickup order, returning one to the importer or his agent and two to the carrier making delivery.
