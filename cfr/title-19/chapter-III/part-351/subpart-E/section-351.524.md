...
![](/graphics/er25no98.006.gif)Where:Ak = the amount of the benefit allocated to year k,y = the face value of the subsidy,n = the AUL (see paragraph (d)(2) of this section),d = the discount rate (see paragraph (d)(3) of this section), andk = the year of allocation, where the year of receipt = 1 and 1 ≤k ≤n.
