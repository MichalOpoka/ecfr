...
(F) Guidelines for the ignition of the H2S bearing gas. The Plan shall designate the title or position of the person(s) who has the authority to ignite the escaping gas and define when, how, and by whom the gas is to be ignited;
...
(H) For production facilities, a description of the detection system(s) utilized to determine the concentration of H2S released.