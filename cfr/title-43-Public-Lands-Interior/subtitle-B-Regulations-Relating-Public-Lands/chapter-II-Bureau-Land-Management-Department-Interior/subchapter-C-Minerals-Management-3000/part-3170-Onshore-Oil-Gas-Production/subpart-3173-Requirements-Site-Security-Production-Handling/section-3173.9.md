...
{[(X + Y − W)/Z1] \* Z2} + X = A,Where:A = calculated end of month inventory;W = first inventory measurement;X = second inventory measurement;Y = gross sales volume between the first and second inventory;Z1 = number of actual days produced between the first and second inventory; andZ2 = number of actual days produced between the second inventory and end of calendar month for which the OGOR report is due.
