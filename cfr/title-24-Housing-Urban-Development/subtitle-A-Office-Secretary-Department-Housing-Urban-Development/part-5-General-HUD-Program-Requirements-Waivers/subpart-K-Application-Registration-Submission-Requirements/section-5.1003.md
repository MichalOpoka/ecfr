...
(a) Every application for a new or renewal of a grant, cooperative agreement, capital fund or operating fund subsidy, capital advance, or other assistance, including an application or plan under a grant program that is classified by OMB as including formula grant programs, must include a unique entity identifiernumber for the applicant.
...
(d) In cases where individuals apply for funding, but the funding will be awarded to an institution or other entity on the individual's behalf, the institution or entity must obtain a unique entity identifier and the individual must submit the institution's DUNS number with the application.
