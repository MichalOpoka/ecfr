...
TTWR = WR (before additions) \* [(NTP (before additions) + NTA)/NTP (before additions)]Where:TTWR = total transmission wheeling revenuesWR (before additions) = wheeling revenues (before additions)NTA = new transmission additionsNTP (before additions) = Net Transmission Plant (before additions)
