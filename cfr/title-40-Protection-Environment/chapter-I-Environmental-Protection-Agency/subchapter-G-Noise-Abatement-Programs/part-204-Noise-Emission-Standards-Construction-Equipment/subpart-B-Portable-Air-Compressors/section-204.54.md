...
*L* = 10 log (1/5[Antilog L1/10 + Antilog *L*2/10 + Antilog *L*3/10 + Antilog *L*4/10 + Antilog *L*5/10]) Where: *L* = The average A-weighted sound level (in decibels) *L*1 = The A-weighted sound level (in decibels) at microphone position 1 *L*2 = The A-weighted sound level (in decibels) at microphone position 2 *L*3 = The A-weighted sound level (in decibels) at microphone position 3 *L*4 = The A-weighted sound level (in decibels) at microphone position 4 *L*5 = The A-weighted sound level (in decibels) at microphone position 5
