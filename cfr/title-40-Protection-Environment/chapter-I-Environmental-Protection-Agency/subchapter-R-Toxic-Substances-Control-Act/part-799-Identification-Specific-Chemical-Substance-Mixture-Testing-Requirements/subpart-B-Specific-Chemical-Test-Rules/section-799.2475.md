...
(B) A heritable translocation assay shall be conducted with MBT in accordance with the test guideline specified in § 798.5460 of this chapter if MBT produces a positive result in the dominant lethal assay conducted pursuant to paragraph (e)(4)(i)(A) of this section and if, after a public program review, EPA issues a Federal Register notice or sends a certified letter to the test sponsor specifying that the testing shall be initiated.
