...
|      Hexachlorobenzene       |     |                       |                                                |           |
|        Elution method        | 15  |9.21 × 10<sup>−3</sup> |2.06 × 10<sup>−3</sup> to 2.16 × 10<sup>−2</sup>|     6     |
|                              | 25  |9.96 × 10<sup>−3</sup> |1.19 × 10<sup>−3</sup> to 2.31 × 10<sup>−2</sup>|     7     |
...
Figure 1—Concentration versus Time of Substance in the Eluate![](/graphics/er15de00.051.gif)
...
Figure 2—Schematic Test Arrangement![](/graphics/er15de00.052.gif)
...
Figure 3—Microcolumn (all dimensions in millimeters)![](/graphics/er15de00.053.gif)
...
|---------------------------------------|------|------|------|------|------|------|------|
|Total volume H<sub>2</sub> O added (mL)| 0.1  | 0.5  |  1   |  2   |  10  | 100  | ≤100 |
...
Figure 4—Test Arrangement for the Determination of Solubility in Water of Slightly Soluble, Low Volatility Organic Substances![](/graphics/er15de00.054.gif)1 = Leveling vessel (e.g. 2.5 L chemical flask) 2 = Column (see figure 3 in paragraph (d)(1)(i)(A)(*2*) of this section) 3 = Fraction accumulator 4 = Thermostat 5 = Teflon tubing 6 = Glass stopper 7 = Water line (between thermostat and column, inner diameter: approximately 8 mm)
