...
Equal aliquots of test solutions may be removed from each test chamber and pooled for analysis. Among replicate test chambers of a treatment concentration, the measured concentration of the test substance should not vary more than 20 percent.
...
(10) An LC50 value based on the number of dead adults with corresponding 95 percent confidence intervals for days 7, 14, 21 and 28. These calculations shall be made using the average measured concentration of the test substance.
