...
(2) In the upper middle portion of the field, include the following statement: “\_\_\_ range from *x* to *y* MPG. The best vehicle rates *z* MPGe.” Fill in the blank with the appropriate vehicle class (such as Small SUVs). For *x, y,* and *z,* insert the appropriate values established by EPA.
