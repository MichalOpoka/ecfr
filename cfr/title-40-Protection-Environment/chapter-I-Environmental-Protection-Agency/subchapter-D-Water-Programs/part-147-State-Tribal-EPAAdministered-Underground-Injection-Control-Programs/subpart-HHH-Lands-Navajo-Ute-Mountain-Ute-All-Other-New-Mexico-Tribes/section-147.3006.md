...
Pm = 0.2dwhere:Pm = injection pressure at the wellhead in pounds per square inch d = depth in feet to the top of the injection zone.Owners and operators shall comply with this requirement no later than one year after the effective date of this program.
