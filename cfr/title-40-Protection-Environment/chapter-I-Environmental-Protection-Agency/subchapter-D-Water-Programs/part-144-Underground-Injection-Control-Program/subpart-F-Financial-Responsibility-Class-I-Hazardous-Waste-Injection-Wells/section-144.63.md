...
![](/graphics/ec15no91.138.gif)where PE is the current plugging and abandonment cost estimate, CV is the current value of the trust fund, and Y is the number of years remaining in the pay-in period.
...
![](/graphics/ec15no91.139.gif)where PE is the current plugging and abandonment cost estimate, CV is the current value of the trust fund, and Y is the number of years remaining in the pay-in period.
