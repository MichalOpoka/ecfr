...
![](/graphics/ec15no91.129.gif)is the inactivation ratio. The sum of the inactivation ratios, or total inactivation ratio shown as ![](/graphics/ec15no91.130.gif)is calculated by adding together the inactivation ratio for each disinfection sequence. A total inactivation ratio equal to or greater than 1.0 is assumed to provide a 3-log inactivation of *Giardia lamblia* cysts.
...
[40 FR 59570, Dec. 24, 1975]Editorial Note:For Federal Register citations affecting § 141.2, see the List of CFR Sections Affected, which appears in the Finding Aids section of the printed volume and at *www.govinfo.gov.*