...
(ii) Limit releases of radon-222 from uranium byproduct materials to the atmosphere so as to not exceed an average 2 release rate of 20 picocuries per square meter per second (pCi/m2s).
