...
(g) Subtract each buoyancy-corrected tare mass of the sample medium (e.g., filter) from its respective buoyancy-corrected mass. The result is the net PM mass, *m*PM. Use *m*PM in emission calculations in § 1065.650.
