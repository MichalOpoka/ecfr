...
(1) We designate angular speed, *f*n, of an engine's crankshaft in revolutions per minute (r/min), rather than the SI unit of radians per second (rad/s). This is based on the commonplace use of r/min in many engine dynamometer laboratories.
