...
|  Compound  |Response  <br/>factor (RF)|
|------------|--------------------------|
|acetaldehyde|           0.50           |
|  ethanol   |           0.75           |
|formaldehyde|           0.00           |
...
(10) Divide the mean measured concentration by the recorded span concentration of the alcohol/carbonyl calibration gas on a C1-equivalent basis. The result is the FID analyzer's response factor for alcohol/carbonyl, *RF*OHCi[THC-FID] on a C1-equivalent basis.
