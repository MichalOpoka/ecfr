...
This section describes an alternate method for calculating drag area, *C*d*A*, for tractors using wind tunnel testing.
...
(1) The Overall Vehicle Reynolds number, *Re*#w, must be at least 1.0·106. Tests for Reynolds effects described in Section 7.1 of SAE J1252 are not required.
