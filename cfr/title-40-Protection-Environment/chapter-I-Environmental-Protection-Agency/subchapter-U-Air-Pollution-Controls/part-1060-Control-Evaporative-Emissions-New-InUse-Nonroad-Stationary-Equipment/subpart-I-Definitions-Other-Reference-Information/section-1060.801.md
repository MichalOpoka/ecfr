...
*Low-permeability material* means, for gaskets, a material with permeation emission rates at or below 10 (g-mm)/m2/day when measured according to SAE J2659 (incorporated by reference in § 1060.810), where the test temperature is 23 °C, the test fuel is Fuel CE10, and testing immediately follows a four-week preconditioning soak with the test fuel.
