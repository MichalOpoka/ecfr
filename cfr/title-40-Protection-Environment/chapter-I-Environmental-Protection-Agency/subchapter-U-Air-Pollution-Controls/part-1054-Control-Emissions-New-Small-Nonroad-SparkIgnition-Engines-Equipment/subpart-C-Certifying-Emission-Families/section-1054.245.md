...
![](/graphics/er29jn21.169.gif)Where:NE = engine-out emission levels (pre-catalyst) from the low-hour test result for a given pollutant, in g/kW-hr.EDF = the deterioration factor specified in paragraph (c)(1) of this section for the type of engine for a given pollutant.CC = the catalyst conversion from the low-hour test, in g/kW-hr. This is the difference between the official emission result and NE.F = 1.0 for NOX and 0.8 for HC and CO.
