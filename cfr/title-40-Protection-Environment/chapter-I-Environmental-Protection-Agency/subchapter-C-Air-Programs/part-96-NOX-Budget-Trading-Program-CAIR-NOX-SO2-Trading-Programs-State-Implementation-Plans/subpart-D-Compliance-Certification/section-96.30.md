...
(2) At the NOX authorized account representative's option, the serial numbers of the NOX allowances that are to be deducted from each unit's compliance account under § 96.54 for the control period;

(3) At the NOX authorized account representative's option, for units sharing a common stack and having NOX emissions that are not monitored separately or apportioned in accordance with subpart H of this part, the percentage of allowances that is to be deducted from each unit's compliance account under § 96.54(e); and
