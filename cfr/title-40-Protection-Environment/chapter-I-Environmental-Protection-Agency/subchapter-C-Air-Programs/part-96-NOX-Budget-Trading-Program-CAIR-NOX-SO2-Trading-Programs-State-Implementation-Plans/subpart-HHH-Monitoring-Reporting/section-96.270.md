...
(5) Notwithstanding the dates in paragraphs (b)(1) and (2) of this section, for the owner or operator of a CAIR SO2 opt-in unit under subpart III of this part, by the date on which the CAIR SO2 opt-in unit enters the CAIR SO2 Trading Program as provided in § 96.284(g).
...
(d) *Prohibitions.* (1) No owner or operator of a CAIR SO2 unit shall use any alternative monitoring system, alternative reference method, or any other alternative to any requirement of this subpart without having obtained prior written approval in accordance with § 96.275.
