...
(3) To use the alternative sampling frequency outlined in paragraph (a)(2) of this section, an individual monitor must consistently achieve results for benzene at or below 0.7 mg/m3.
...
(3) The action level for benzene is 7 mg/m3 on an annual average basis. If the annual average Δc value for benzene is greater than 7 mg/m3, the concentration is above the action level, and the owner or operator must conduct a root cause analysis and corrective action in accordance with paragraph (d) of this section.
