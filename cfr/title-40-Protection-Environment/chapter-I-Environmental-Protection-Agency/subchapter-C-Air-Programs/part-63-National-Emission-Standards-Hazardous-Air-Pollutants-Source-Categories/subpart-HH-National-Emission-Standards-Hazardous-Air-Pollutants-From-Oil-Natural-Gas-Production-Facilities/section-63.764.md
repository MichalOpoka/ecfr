...
![](/graphics/er02ja07.001.gif)Where:LOPT = Optimal circulation rate, gal/hr.F = Gas flowrate (MMSCF/D).I = Inlet water content (lb/MMSCF).O = Outlet water content (lb/MMSCF).3.0 = The industry accepted rule of thumb for a TEG-to water ratio (gal TEG/lb H2O).1.15 = Adjustment factor included for a margin of safety.
