...
![](/graphics/er27my03.005.gif)Where: Mf = total gaseous organic emissions mass flow rate, kg/hour (kg/h) Cc = concentration of organic compounds as carbon in the vent gas, as determined by Method 25 or Method 25A, parts per million by volume (ppmv), dry basis Qsd = volumetric flow rate of gases entering or exiting the add-on control device, as determined by Method 2, 2A, 2C, 2D, 2F, or 2G, dry standard cubic meters/hour (dscm/h) 0.0416 = conversion factor for molar volume, kg-moles per cubic meter (mol/m3) (@ 293 Kelvin [K] and 760 millimeters of mercury [mmHg]).
