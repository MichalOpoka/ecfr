...
Where:![](/graphics/er04ap24.000.gif)Where:Cm = Average instrument response (ppm).Ca = Certified cylinder gas value (ppm).
...
![](/graphics/er04ap24.001.gif)Where:NHVmeasured = Average instrument response (Btu/scf). NHV calculations must be based on the individual component properties in table 12 of this subpart.NHVa = Certified cylinder gas value (Btu/scf).
...
[80 FR 75266, Dec. 1, 2015, as amended at 89 FR 23861, Apr. 4, 2024]