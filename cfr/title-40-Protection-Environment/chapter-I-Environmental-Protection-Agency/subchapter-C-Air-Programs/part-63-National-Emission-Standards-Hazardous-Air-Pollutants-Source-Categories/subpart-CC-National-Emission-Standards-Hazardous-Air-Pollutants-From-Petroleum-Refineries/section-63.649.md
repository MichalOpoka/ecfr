...
% CL = [(CL−CAN)/Ct + Cc)] × 100where: % CL = Percentage leaking connectors. CL = Number of connectors including nonrepairables, measured at 1,000 parts per million or greater, by Method 21 of 40 CFR part 60, appendix A. CAN = Number of allowable nonrepairable connectors, as determined by monitoring, not to exceed 3 percent of the total connector population, Ct. Ct = Total number of monitored connectors, including nonrepairables, in the process unit. Cc = Optional credit for removed connectors = 0.67 × net number (*i.e.,* the total number of connectors removed minus the total added) of connectors in organic HAP service removed from the process unit after the applicability date set forth in § 63.640(h)(3)(iii) for existing process units, and after the date of start-up for new process units. If credits are not taken, then Cc = 0.
