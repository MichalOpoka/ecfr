...
![](/graphics/er10oc03.001.gif)Where:Elbs/hr = Mass emissions rate of chlorine or hydrochloric acid (lbs/hr);Cs = Concentration of chlorine or hydrochloric acid in the gas stream, milligrams per dry standard cubic meter (mg/dscm);Qstd = Volumetric flow rate of stack gas (dscfm);60 = Conversion factor (min/hr);35.31 = Conversion factor (dscf/dscm); and454,000 = Conversion factor (mg/lb).