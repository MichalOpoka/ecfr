...
(Eq. 1) ![](/graphics/er18oc02.002.gif)Where: Pb = Percent of HAP solvent discharged to the atmosphere for each mix batch, percent; Srec = Weight of HAP solvent recovered for each mix batch, lb; Smix = Weight of HAP solvent loaded into the solvent mixer for each mix batch, lb.
...
![](/graphics/er18oc02.003.gif)Where: %P7 = 7-day block average percent of HAP solvent discharged to the atmosphere, percent; i = mix batch; n = number of mix batches in 7-day block average.
