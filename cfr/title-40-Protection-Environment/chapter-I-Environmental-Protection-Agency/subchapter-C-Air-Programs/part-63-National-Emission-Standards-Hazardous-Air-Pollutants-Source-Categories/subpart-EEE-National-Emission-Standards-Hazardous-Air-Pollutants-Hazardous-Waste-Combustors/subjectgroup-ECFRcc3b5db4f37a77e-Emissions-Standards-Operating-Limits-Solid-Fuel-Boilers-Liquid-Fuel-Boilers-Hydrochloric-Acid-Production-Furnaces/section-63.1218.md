...
SRE = [1 − (Cl out / Cl in)] × 100% Where: Cl in = mass feedrate of total chlorine or chloride in all feedstreams, reported as chloride; and Cl out = mass emission rate of hydrogen chloride and chlorine gas, reported as chloride, in exhaust emissions prior to release to the atmosphere.
...
DRE = [1 − (W out / W in)] × 100% Where: Win = mass feedrate of one POHC in a waste feedstream; and Wout = mass emission rate of the same POHC present in exhaust emissions prior to release to the atmosphere.
