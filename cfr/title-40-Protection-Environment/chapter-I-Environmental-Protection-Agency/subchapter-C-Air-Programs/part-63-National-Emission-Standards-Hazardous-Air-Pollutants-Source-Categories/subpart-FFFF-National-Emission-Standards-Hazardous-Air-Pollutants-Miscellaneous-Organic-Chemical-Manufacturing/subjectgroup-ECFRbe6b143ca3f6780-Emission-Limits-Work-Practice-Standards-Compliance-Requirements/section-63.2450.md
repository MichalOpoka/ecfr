...
![](/graphics/er12au20.000.gif)Where:Cm = Average instrument response (ppm).Ca = Certified cylinder gas value (ppm).
...
![](/graphics/er12au20.001.gif)Where:NHVmeasured = Average instrument response (Btu/scf).NHVa = Certified cylinder gas value (Btu/scf).
