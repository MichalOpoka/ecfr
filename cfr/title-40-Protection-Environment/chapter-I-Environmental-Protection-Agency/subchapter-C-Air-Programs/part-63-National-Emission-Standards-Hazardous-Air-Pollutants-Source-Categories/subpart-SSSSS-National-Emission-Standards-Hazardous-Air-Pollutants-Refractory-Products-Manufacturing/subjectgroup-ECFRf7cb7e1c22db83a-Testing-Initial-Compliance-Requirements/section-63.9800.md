...
![](/graphics/er16ap03.000.gif)Where: C THC-C = THC concentration, corrected to 18 percent oxygen, parts per million by volume, dry basis (ppmvd) C THC = THC concentration (uncorrected), ppmvd CO2 = oxygen concentration, percent.
...
![](/graphics/er16ap03.001.gif)Where: PR = percentage reduction, percent ERi = mass emissions rate of specific HAP or pollutant (THC, HF, or HCl) entering the control device, kilograms (pounds) per hour ERo = mass emissions rate of specific HAP or pollutant (THC, HF, or HCl) exiting the control device, kilograms (pounds) per hour.
...
![](/graphics/er19no21.573.gif)Where:CHg-C = Hg concentration, corrected to 18 percent oxygen, micrograms per dry standard cubic meters (µg/dscm)CHg = Hg concentration (uncorrected), µg/dscmCO2 = oxygen concentration, percent.
