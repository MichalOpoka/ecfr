...
![](/graphics/ec21oc91.019.gif)where %W = the required weighted percent reductionΣ Mg = the total mass rate (e.g., kg/yr) of all gaseous emissions Σ Mp = the total mass rate of all particulate emissions and,
