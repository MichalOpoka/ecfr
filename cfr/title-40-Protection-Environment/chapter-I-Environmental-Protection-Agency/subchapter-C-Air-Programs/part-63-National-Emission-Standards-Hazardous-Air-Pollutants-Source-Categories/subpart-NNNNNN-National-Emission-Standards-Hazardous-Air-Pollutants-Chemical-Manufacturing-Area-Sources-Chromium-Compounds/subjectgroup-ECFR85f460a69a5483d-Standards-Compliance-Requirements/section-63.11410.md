...
![](/graphics/er16jy07.002.gif)Where:E = Mass emissions of PM, pounds per hour (lb/hr);C = Concentration of PM, grains per dry standard cubic foot (gr/dscf);Q = Volumetric flow rate of stack gas, dry standard cubic foot per hour (dscf/hr); andK = Conversion factor, 7,000 grains per pound (gr/lb).
