...
Equation 1 to Paragraph (b)(2)(i)(A)![](/graphics/er27mr23.004.gif)Where n is the number of coatings of each type used during each nominal 1-month period and m is the number of different diluent VOC's used during each nominal 1-month period. (Σ Ldj Ddj will be 0 if no VOC's are added to the coatings, as received.)
...
Equation 2 to Paragraph (b)(2)(i)(B)![](/graphics/er27mr23.005.gif)Where n is the number of coatings of each type used during each nominal 1-month period.
...
Equation 3 to Paragraph (b)(2)(i)(D)![](/graphics/er27mr23.006.gif)Where n is the number of coatings of each type used and p is the number of application methods used.

|     Application methods      |Transfer  <br/>efficiency|                Type of coating                |
|------------------------------|-------------------------|-----------------------------------------------|
...
Equation 4 to Paragraph (b)(2)(i)(E)![](/graphics/er27mr23.007.gif)Where Tavg = T when only one type of coating operation occurs.
