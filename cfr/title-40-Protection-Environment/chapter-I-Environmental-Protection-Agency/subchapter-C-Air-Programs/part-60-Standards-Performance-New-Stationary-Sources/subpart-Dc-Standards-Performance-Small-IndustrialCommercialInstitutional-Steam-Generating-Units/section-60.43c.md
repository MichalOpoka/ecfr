...
(4) An owner or operator of an affected facility that commences construction, reconstruction, or modification after February 28, 2005, and that combusts only oil that contains no more than 0.50 weight percent sulfur or a mixture of 0.50 weight percent sulfur oil with other fuels not subject to a PM standard under § 60.43c and not using a post-combustion technology (except a wet scrubber) to reduce PM or SO2 emissions is not subject to the PM limit in this section.
