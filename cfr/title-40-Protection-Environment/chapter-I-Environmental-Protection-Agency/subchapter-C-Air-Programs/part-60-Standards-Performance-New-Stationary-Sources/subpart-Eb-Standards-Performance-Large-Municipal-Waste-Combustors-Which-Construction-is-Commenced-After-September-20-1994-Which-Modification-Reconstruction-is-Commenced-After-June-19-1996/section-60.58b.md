...
![](/graphics/er19de95.001.gif)where:%PHg = percent reduction of the potential mercury emissions achieved. Ei = potential mercury emission concentration measured at the control device inlet, corrected to 7 percent oxygen (dry basis). Eo = controlled mercury emission concentration measured at the mercury control device outlet, corrected to 7 percent oxygen (dry basis).
...
![](/graphics/er19de95.002.gif)where:%PHCl = percent reduction of the potential hydrogen chloride emissions achieved. Ei = potential hydrogen chloride emission concentration measured at the control device inlet, corrected to 7 percent oxygen (dry basis).Eo = controlled hydrogen chloride emission concentration measured at the control device outlet, corrected to 7 percent oxygen (dry basis).
