...
(b) The owner or operator shall determine compliance with the particulate matter, sulfur dioxide (SO2), and visible emission standards in §§ 60.182, 60.183, and 60.184 as follows:
...
(2) The continuous monitoring system of § 60.185(a)(2) shall be used to determine the SO2 concentrations on a dry basis. The sampling time for each run shall be 2 hours, and the average SO2 concentration for the 2-hour period shall be computed as in § 60.185(b). The monitoring system drift during the run may not exceed 2 percent of the span value.
