...
![](/graphics/er41ad07.005.gif)

(ii) If Cave,j \<3 µg/m3 for any test period, data from that test period are unacceptable, and an additional sample collection set must be obtained to replace the unacceptable data.
