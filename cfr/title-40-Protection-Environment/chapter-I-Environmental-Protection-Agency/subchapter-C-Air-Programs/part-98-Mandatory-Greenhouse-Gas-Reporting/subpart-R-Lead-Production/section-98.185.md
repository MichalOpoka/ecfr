...
(a) For each missing data for the carbon content for the smelting furnaces at your facility that estimate annual process CO2 emissions using the carbon mass balance procedure in § 98.183(b)(2)(i) and (ii), 100 percent data availability is required. You must repeat the test for average carbon contents of inputs according to the procedures in § 98.184(b) if data are missing.
