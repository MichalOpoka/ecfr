...
|Type of control strategy SIP|Year|VOC (TPD)|NO<sub>X</sub> (TPD)|
|----------------------------|----|---------|--------------------|
...
|Type of control strategy SIP|Year|VOC  <br/>(TPD)|NO<sub>X</sub> (TPD)|Effective date of adequacy determination  <br/>or SIP approval|
|----------------------------|----|---------------|--------------------|--------------------------------------------------------------|
...
|Type of control strategy SIP|Year|VOC  <br/>(TPD)|NO<sub>X</sub>  <br/>(TPD)|Effective date of adequacy determination or SIP approval|
|----------------------------|----|---------------|--------------------------|--------------------------------------------------------|
...
|Type of control  <br/>strategy SIP|Year|VOC  <br/>(TPD)|NO<sub>X</sub>  <br/>(TPD)|Effective date of adequacy  <br/>determination or  <br/>SIP approval|
|----------------------------------|----|---------------|--------------------------|--------------------------------------------------------------------|
...
|Type of control strategy SIP|Year|VOC  <br/>(TPD)|NO<sub>X</sub>  <br/>(TPD)|
|----------------------------|----|---------------|--------------------------|
...
|Type of control strategy SIP|Year|VOC (TPD)|NO<sub>X</sub> (TPD)| Effective date of adequacy determination or SIP approval  |
|----------------------------|----|---------|--------------------|-----------------------------------------------------------|
...
|Type of control strategy SIP|           Year           |     VOC  <br/>(TPD)      |NO<sub>X</sub>  <br/>(TPD) |Effective date of adequacy determination of SIP approval|
|----------------------------|--------------------------|--------------------------|---------------------------|--------------------------------------------------------|
|      Maintenance Plan      |2014  <br/>2025  <br/>2030|61.3  <br/>33.2  <br/>40.7|136.8  <br/>24.1  <br/>27.4|                       5/15/2019.                       |

|Type of control strategy SIP|           Year           |     VOC  <br/>(TPD)      |NO<sub>X</sub>  <br/>(TPD) |Effective date of adequacy determination of SIP approval|
|----------------------------|--------------------------|--------------------------|---------------------------|--------------------------------------------------------|
|      Maintenance Plan      |2014  <br/>2025  <br/>2030|61.3  <br/>39.8  <br/>28.9|136.8  <br/>48.8  <br/>32.9|Contingent and effective upon interagency consultation. |
...
|                     Year                     |VOC onroad  <br/>emissions  <br/>(tpd)|NO<sub>X</sub> onroad  <br/>emissions  <br/>(tpd)|
|----------------------------------------------|--------------------------------------|-------------------------------------------------|
