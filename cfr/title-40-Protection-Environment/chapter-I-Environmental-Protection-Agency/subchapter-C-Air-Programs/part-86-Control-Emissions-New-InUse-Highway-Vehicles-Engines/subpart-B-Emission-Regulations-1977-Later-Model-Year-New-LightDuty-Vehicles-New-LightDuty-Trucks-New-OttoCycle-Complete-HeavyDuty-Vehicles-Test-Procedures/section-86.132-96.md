...
F = To + 0.4t; orfor SI units,C = To + (2/9)t.Where,F = fuel temperature, °F;C = fuel temperature, °C;t = time since beginning of test, minutes; andTo = initial temperature in °F (°C for SI units).
