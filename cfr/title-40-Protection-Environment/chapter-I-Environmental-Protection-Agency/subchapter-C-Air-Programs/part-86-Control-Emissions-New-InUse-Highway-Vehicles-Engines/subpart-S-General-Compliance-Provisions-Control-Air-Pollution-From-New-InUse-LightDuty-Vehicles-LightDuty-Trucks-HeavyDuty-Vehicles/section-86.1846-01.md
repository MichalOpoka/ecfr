...
(2) A manufacturer shall test a test group, or a subset of a test group, as described in paragraph (j) of this section when the results from testing conducted under § 86.1845 show mean exhaust emissions of CO2 (City-highway combined CREE) for that test group to be at or above the applicable in-use standard for at least 50 percent of vehicles tested from the test group.
