...
(ii) If the averaging time for any specified VOC or NOX mass emissions caps or emission rate limits for stationary sources (and for other sources, as appropriate) is longer than 24 hours, the State shall provide, in support of the SIP submittal, a statistical showing that the specified averaging time is consistent with attaining the O3 NAAQS and satisfying RFP requirements, as applicable, on the basis of typical summer day emissions; and, if applicable, a statistical showing that the longer averaging time will produce emissions reductions that are equivalent on a daily basis to source-specific RACT requirements.
