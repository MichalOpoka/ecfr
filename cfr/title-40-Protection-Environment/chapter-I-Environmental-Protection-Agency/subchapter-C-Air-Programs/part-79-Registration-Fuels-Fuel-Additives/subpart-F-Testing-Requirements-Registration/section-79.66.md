...
(D) *Sampling.* Cross-sections of the following areas shall be examined: The forebrain, the center of the cerebrum, the midbrain, the cerebellum, and the medulla oblongata; the spinal cord at the cervical swelling (C3-C6), and proximal sciatic nerve (mid-thigh and sciatic notch) or tibial nerve (at knee). Other sites and tissue elements (e.g., gastrocnemius muscle) shall be examined if deemed necessary. Any observable gross changes shall be recorded.
