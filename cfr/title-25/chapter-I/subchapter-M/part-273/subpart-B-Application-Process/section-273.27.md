...
(b) Review the application for completeness and request within 20 days any additional information from the applicant which will be needed to reach a decision.

(c) On receiving an application for operational support, make formal written determination and findings supporting the need for such funds. In arriving at such a determination, the Commissioner must be assured that each local education agency has made a good faith effort in computing State and local contributions without regard to funds requested pursuant to this part.
...
(f) Promptly notify the applicant in writing of the decision to approve or disapprove the application. If the application is disapproved, the notice will give the reasons for disapproval and the applicant's right to appeal pursuant to part 2 of this chapter.