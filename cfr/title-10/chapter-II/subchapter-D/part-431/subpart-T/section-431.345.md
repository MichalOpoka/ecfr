...
|                      Equipment class                       |            Minimum package isentropic efficiency            |               η<sub>Regr</sub>  <br/>(package isentropic efficiency reference curve)                |d  <br/>(percentage loss reduction)|
|------------------------------------------------------------|-------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|-----------------------------------|
|   Rotary, lubricated, air-cooled, fixed-speed compressor   |    η<sub>Regr</sub> + (1 − η<sub>Regr</sub>) \* (d/100)     |−0.00928 \* ln<sup>2</sup> (.4719 \* V<sub>1</sub>) + 0.13911 \* ln(.4719 \* V<sub>1</sub>) + 0.27110|                −15                |
| Rotary, lubricated, air-cooled, variable-speed compressor  |    η<sub>Regr</sub> + (1 − η<sub>Regr</sub>) \* (d/100)     |−0.01549 \* ln<sup>2</sup> (.4719 \* V<sub>1</sub>) + 0.21573 \* ln(.4719 \* V<sub>1</sub>) + 0.00905|                −10                |
| Rotary, lubricated, liquid-cooled, fixed-speed compressor  |.02349 + η<sub>Regr</sub> + (1 − η<sub>Regr</sub>) \* (d/100)|−0.00928 \* ln<sup>2</sup> (.4719 \* V<sub>1</sub>) + 0.13911 \* ln(.4719 \* V<sub>1</sub>) + 0.27110|                −15                |
|Rotary, lubricated, liquid-cooled, variable-speed compressor|.02349 + η<sub>Regr</sub> + (1 − η<sub>Regr</sub>) \* (d/100)|−0.01549 \* ln<sup>2</sup> (.4719 \* V<sub>1</sub>) + 0.21573 \* ln(.4719 \* V<sub>1</sub>) + 0.00905|                −15                |
