...
The receipt, possession, use, and transfer of this device, Model\* \_\_\_\_\_\_\_, Serial No.\* \_\_\_, containing \_\_\_\_\_\_ (Identity and quantity of radioactive material) are subject to a general license or the equivalent and the regulations of the U.S. NRC or of a State with which the NRC has entered into an agreement for the exercise of regulatory authority. Do not remove this label.

CAUTION—RADIOACTIVE MATERIAL(Name of manufacturer, assembler, or initial transferor.)\*
