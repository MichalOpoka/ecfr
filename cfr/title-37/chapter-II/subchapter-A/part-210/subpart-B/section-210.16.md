...
(ii) *Step 2: Subtract the number of phonorecords reserved.* This involves deducting, from the subtotal arrived at in Step 1, the number of phonorecords that have been placed in the phonorecord reserve for the month covered by the Monthly Statement. The number of phonorecords reserved is determined by multiplying the subtotal from Step 1 by the percentage reserve level established under GAAP. This step should be skipped by a compulsory licensee barred from maintaining reserves under § 210.15.
