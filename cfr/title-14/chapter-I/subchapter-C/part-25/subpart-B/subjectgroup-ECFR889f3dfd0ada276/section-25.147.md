...
(2) The power required for level flight at 1.3 *V*SR1, but not more than maximum continuous power;
...
(c) *Lateral control; general.* It must be possible to make 20° banked turns, with and against the inoperative engine, from steady flight at a speed equal to 1.3 *V*SR1, with—
...
(e) *Lateral control; airplanes with four or more engines.* Airplanes with four or more engines must be able to make 20° banked turns, with and against the inoperative engines, from steady flight at a speed equal to 1.3 *V*SR1, with maximum continuous power, and with the airplane in the configuration prescribed by paragraph (b) of this section.
