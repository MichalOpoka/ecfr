...
Example.Partner A of Partnership P treats a deduction and a capital gain arising from P on A's return in a manner that is inconsistent with the treatment of those items by P. A reports the inconsistent treatment of the deduction but not of the gain. A is subject to a computational adjustment under section 6222(c) with respect to the gain.
