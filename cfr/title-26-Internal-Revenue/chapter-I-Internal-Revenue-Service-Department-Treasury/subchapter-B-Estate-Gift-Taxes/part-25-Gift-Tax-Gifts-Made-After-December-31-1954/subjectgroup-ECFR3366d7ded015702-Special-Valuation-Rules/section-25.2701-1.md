...
Example.A, an individual, holds all the outstanding stock of S Corporation. A exchanges A's shares in S for 100 shares of 10-percent cumulative preferred stock and 100 shares of voting common stock. A transfers the common stock to A's child. Section 2701 applies to the transfer because A has transferred an equity interest (the common stock) to a member of A's family, and immediately thereafter holds an applicable retained interest (the preferred stock). A's preferred stock is valued under the rules of section 2701. A's gift is determined under the subtraction method by subtracting the value of A's preferred stock from the value of A's interest in S immediately prior to the transfer.
