...
Example.(a) A, the owner of 20% of T's only class of stock, transfers that stock to P solely in exchange for all of the P stock. Pursuant to the same transaction, P, solely in exchange for cash, acquires the remaining 80% of the T stock from T's other shareholder, B, who is unrelated to A and P.
