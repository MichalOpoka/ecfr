...
(2) *S portion.* The S portion of an ESBT is the portion of the trust that consists of S corporation stock and that is not treated as owned by the grantor or another person under subpart E.
...
*B* must take into account the items of income attributable to the grantor portion, that is, 10% of each item, as follows:
