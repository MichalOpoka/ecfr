...
Q-3. In the case of distributions from an IRA, what does the term *required beginning date* mean?

A-3. In the case of distributions from an IRA, the term *required beginning date* means April 1 of the calendar year following the calendar year in which the individual attains age 701/2.
...
A-11. (a) *General rule.* Except as provided in paragraph (b) of this A-11, all amounts distributed from an IRA are taken into account in determining whether section 401(a)(9) is satisfied, regardless of whether the amount is includible in income.
...
A-12. (a) *General rule.* The special rule in A-3(d) of § 1.401(a)(9)-5 for a QLAC, defined in A-17 of § 1.401(a)(9)-6, applies to an IRA, subject to the exceptions set forth in this A-12. See A-14(d) of § 1.408A-6 for special rules relating to Roth IRAs.

(b) *Limitations on premiums*—(1) *In general.* In lieu of the limitations described in A-17(b) of § 1.401(a)(9)-6, the premiums paid with respect to the contract on a date are not permitted to exceed the lesser of the dollar limitation in paragraph (b)(2) of this A-12 or the percentage limitation in paragraph (b)(3) of this A-12.
...
(c) *Reliance on representations.* For purposes of the limitations described in paragraphs (b)(2) and (3) of this A-12, unless the trustee, custodian, or issuer of an IRA has actual knowledge to the contrary, the trustee, custodian, or issuer may rely on the IRA owner's representation (made in writing or such other form as may be prescribed by the Commissioner) of—
