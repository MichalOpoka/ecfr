...
Example 2.Assuming the facts to be the same as in example 1, the mean of M's assets for the taxable year 1958 is computed as follows:
...
Example 4.Assuming the facts to be the same as in example 3, the mean of N's assets for the taxable year 1958 is computed as follows:
