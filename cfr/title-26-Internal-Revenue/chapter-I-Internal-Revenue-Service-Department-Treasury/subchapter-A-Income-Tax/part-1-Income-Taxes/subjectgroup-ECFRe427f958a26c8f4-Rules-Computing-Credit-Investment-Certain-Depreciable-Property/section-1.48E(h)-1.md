...
|                      Category                      |Capacity  <br/>limitation  <br/>(DC)|
|----------------------------------------------------|------------------------------------|
...
(B) *PM*2.5*. PM*2.5 is defined as fine inhalable particles with 2.5 or smaller micrometer diameters. The percentile is the weight of the particles per cubic meter.
