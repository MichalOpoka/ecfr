...
(ii) *Timing.* A section 965(n) election must be made no later than the due date (taking into account extensions, if any) for the person's return for the taxable year to which the election applies. Relief is not available under § 301.9100-2 or § 301.9100-3 to make a late election.
...
Example 2.(ii)(A) *Facts.* The facts are the same as in paragraph (f)(6)(i)(A) of this section (the facts in *Example 1*), except that a deficit of 3,040u was incurred during the taxable year that includes October 31, 2017.
