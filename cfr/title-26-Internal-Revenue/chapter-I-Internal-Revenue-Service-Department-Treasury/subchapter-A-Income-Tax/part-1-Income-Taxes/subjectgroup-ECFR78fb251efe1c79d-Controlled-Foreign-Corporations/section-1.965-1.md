...
(ii) *Specified commodity.* The term *specified commodity* means a commodity held by a specified foreign corporation that, in the hands of the specified foreign corporation, is property described in section 1221(a)(1) or 1221(a)(8). This paragraph (f)(13)(ii) does not apply with respect to a specified foreign corporation that is a dealer or trader in commodities.
