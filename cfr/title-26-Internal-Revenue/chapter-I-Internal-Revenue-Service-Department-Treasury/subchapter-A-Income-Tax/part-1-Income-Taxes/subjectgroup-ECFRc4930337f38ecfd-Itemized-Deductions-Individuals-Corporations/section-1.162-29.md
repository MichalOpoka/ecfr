...
(ii) Because neither the summary nor the cover letter refers to any specific legislative proposal and no other facts or circumstances indicate that they refer to an existing legislative proposal, forwarding the summary to legislators in State X is not a lobbying communication. Therefore, U is not influencing legislation.
...
(ii) *Analysis.* The letter is a lobbying communication (because it refers to and reflects a view on specific legislation, the governor's proposed budget). Y's estimate of additional costs under the proposal supports the lobbying communication, is proximate in time and similar in subject matter to a specific legislative proposal then in existence, and is not used for a nonlobbying purpose. Based on these facts, Y estimated its additional costs under the budget proposal solely to support the lobbying communication.
