...
Example 4.(i) The facts are the same as in *Example 3,* except that, rather than contributing the distribution from Plan O to Plan M, Employee A contributes the distribution from Plan O to IRA P, an individual retirement account described in section 408(a). After the contribution of the distribution from Plan O to IRA P, but before the year in which Employee A attains age 701/2, Employee A requests a distribution from IRA P and decides to contribute it to Plan M as a rollover contribution. To make the rollover contribution, Employee A endorses the check received from IRA P as payable to Plan M.
