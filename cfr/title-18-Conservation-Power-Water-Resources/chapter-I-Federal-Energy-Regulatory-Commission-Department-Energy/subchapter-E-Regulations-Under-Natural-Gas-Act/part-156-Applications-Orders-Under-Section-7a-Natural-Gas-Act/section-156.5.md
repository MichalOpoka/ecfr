...
(a) *Exhibits to be submitted with application.* All of the following exhibits shall be submitted with the application when tendered for filing. Such exhibits may be attached to the application or furnished in a separate volume or separate volumes designated “Exhibits to Application.” Such separate volume or volumes shall indicate on the cover thereof applicant's name and bear Docket No. CP- \_\_\_\_\_\_ (number designation to be left blank).
