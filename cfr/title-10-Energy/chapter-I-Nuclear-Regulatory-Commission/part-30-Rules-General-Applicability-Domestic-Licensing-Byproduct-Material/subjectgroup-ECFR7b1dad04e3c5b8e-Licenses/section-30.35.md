...
(2) Each holder of, or applicant for, any specific license authorizing the possession and use of sealed sources or plated foils of half-life greater than 120 days and in quantities exceeding 1012 times the applicable quantities set forth in appendix B to part 30 (or when a combination of isotopes is involved if R, as defined in § 30.35(a)(1), divided by 1012 is greater than 1), shall submit a decommissioning funding plan as described in paragraph (e) of this section. The decommissioning funding plan must be submitted to NRC by December 2, 2005.
