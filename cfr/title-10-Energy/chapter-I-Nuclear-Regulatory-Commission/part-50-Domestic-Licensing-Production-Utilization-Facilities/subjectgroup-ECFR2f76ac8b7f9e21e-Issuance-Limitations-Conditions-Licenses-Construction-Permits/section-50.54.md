...
Minimum Requirements<sup>1</sup> Per Shift for On-Site Staffing of Nuclear Power Units by Operators and Senior Operators Licensed Under 10 CFR Part 55

|Number of nuclear power units operating<sup>2</sup>|    Position    |    One unit     |    Two units    |    Three units    |              |   |
|---------------------------------------------------|----------------|-----------------|-----------------|-------------------|--------------|---|
...
|                                                   |    Operator    |        2        |        3        |         3         |      4       | 4 |
|                        Two                        |Senior Operator |                 |        2        |         3         |<sup>3</sup> 3| 3 |
|                                                   |    Operator    |                 |        3        |         4         |<sup>3</sup> 5| 5 |
...
<sup>3</sup> The number of required licensed personnel when the operating nuclear power units are controlled from a common control room are two senior operators and four operators.
