...
Link to an amendment published at 82 FR 1475, Jan. 5, 2017.This amendment was delayed until Mar. 21, 2017 at 82 FR 8985, Feb. 2, 2017.Link to an amendment published at 82 FR 1100, Jan. 4, 2017.
...
|                                                          Cooling Capacity (3-Phase)                                                          |                 Heating Season Performance Factor  <br/>Energy Efficiency Ratio                 |        5% (0.05)  <br/>10% (0.1)        |
...
|                                                       6                                                       |Conduct the minimum number of validation tests for the validation classes to which the AEDM is applied at a third-part test facility; And  <br/>Conduct addition testing, which is equal to1/2 the minimum number of validation tests for the validation classes to which the AEDM is applied , at either the manufacturer's facility or a third-party test facility, at the manufacturer's discretion.|
