...
Link to an amendment published at 90 FR 1277, Jan. 7, 2025.Link to a delay published at 90 FR 9001, Feb. 5, 2025.
...
|                                                                                                                                                                                                                     6                                                                                                                                                                                                                      |Conduct the minimum number of validation tests for the validation classes to which the AEDM is applied at a third-part test facility; And  <br/>Conduct addition testing, which is equal to 1/2 the minimum number of validation tests for the validation classes to which the AEDM is applied , at either the manufacturer's facility or a third-party test facility, at the manufacturer's discretion.|
