...
(a) *Product eligibility.* Each product that is the subject of the proposed project must meet the definition of a Value-Added Agricultural Product

(b) *Purpose eligibility.* (1) The grant funds requested must not exceed any maximum amounts specified in the annual solicitation for Planning and Working Capital Grant requests, per § 4284.915.
