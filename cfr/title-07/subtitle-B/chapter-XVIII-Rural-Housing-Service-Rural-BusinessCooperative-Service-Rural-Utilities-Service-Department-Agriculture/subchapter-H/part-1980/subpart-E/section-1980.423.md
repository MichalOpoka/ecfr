...
*Par (a)(6) and (a)(7). (Added 4-26-85, SPECIAL PN.)* The Director will notify the Finance Office of any interest rate reduction by using Form RD 1980-47, “Guaranteed Loan Borrower Adjustments.” The State Director will make corrections to the Rural Community Facility Tracking System (FCFTS) reflecting the interest rate change. The Rural Development loan file, as well as the attachments to the copy of the promissory note in the file, will be documented by the State Director to reflect any change in the interest rate.
