...
(d) *Programs not operated by recipient.* (1) This paragraph applies to any recipient which requires participation by any applicant, student, or employee in any education program or activity not operated wholly by such recipient, or which facilitates, permits, or considers such participation as part of or equivalent to an education program or activity operated by such recipient, including participation in education consortia and cooperative employment and student-teaching assignments.
