...
*Benchmark* refers to the mean of the top decile of Medicare-certified HHA performance on the specified quality measure during the baseline year, calculated separately for the larger- and smaller-volume cohorts.
...
*Improvement threshold* means an individual competing HHA's performance level on a measure during the baseline year.
