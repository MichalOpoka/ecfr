...
(i) The MA organization contract or Multi-Contract Entity (MCE) number (that is, “H” for MA or Section 1876 Cost Plans, “R” for Regional PPO plans (RPPOs), or “Y” for MCE, a means of identification available for Plans/Part D sponsors that have multiple MA contracts) followed by an underscore, except that the SMID for multi-plan marketing materials must begin with the word “MULTI-PLAN” instead of the MA organization's contract number (for example, H1234\_abc123\_C or MULTI-PLAN\_efg456\_M).
...
(iii) An uppercase “C” for communications materials or an uppercase “M” for marketing materials (for example, H1234\_abc123\_C or H5678\_efg456\_M).
