...
(d) *Timing.* (1) *Timeframe for filing* - An enrollee has 60 calendar days from the date on the adverse organization determination notice to file a request for an integrated reconsideration with the applicable integrated plan.
...
(e) *Expedited integrated reconsiderations.* (1) An enrollee may request, or a provider may request on behalf of an enrollee, an expedited review of the integrated reconsideration.
...
(3) *Extensions.* (i) The applicable integrated plan may extend the timeframe for resolving integrated reconsiderations by 14 calendar days if -
