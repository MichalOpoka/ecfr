...
Link to an amendment published at 83 FR 59178, November 21, 2018.
...
(c) *Measure removal, suspension, or replacement through the rulemaking process*. Unless a measure raises specific safety concerns as set forth in paragraph (b) of this section, CMS will use the regular rulemaking process to remove, suspend, or replace quality measures in the ASCQR Program to allow for public comment.

(1) *Criteria for removal of quality measures*. (i) CMS will use the following criteria to determine whether to remove a measure from the ASCQR Program:
...
(2) *Criteria to determine topped-out measures*. For the purposes of the ASCQR Program, a measure is considered to be topped-out under paragraph (c)(1)(i)(A) of this section when it meets both of the following criteria:
