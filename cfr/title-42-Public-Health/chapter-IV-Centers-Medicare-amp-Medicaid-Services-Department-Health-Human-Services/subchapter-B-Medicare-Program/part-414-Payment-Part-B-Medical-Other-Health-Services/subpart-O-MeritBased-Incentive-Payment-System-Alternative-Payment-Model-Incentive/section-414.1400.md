...
Link to an amendment published at 84 FR 63198, Nov. 15, 2019.
...
(f) *Remedial action and termination of third party intermediaries.* (1) If CMS determines that a third party intermediary has ceased to meet one or more of the applicable criteria for approval, or has submitted data that is inaccurate, unusable, or otherwise compromised, CMS may take one or more of the following remedial actions after providing written notice to the third party intermediary:
