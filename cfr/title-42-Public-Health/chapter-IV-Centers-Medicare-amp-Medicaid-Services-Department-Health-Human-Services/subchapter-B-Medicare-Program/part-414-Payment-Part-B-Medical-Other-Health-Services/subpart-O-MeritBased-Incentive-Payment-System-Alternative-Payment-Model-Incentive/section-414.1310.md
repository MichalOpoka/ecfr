...
Link to an amendment published at 85 FR 85030, Dec. 28, 2020.
...
(e) *Requirements for groups.* (1) Except as provided under § 414.1370(f)(2), each MIPS eligible clinician in the group will receive a MIPS payment adjustment factor (or additional MIPS payment adjustment factor) based on the group's combined performance assessment.
