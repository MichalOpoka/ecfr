...
(c)(1) CMS issues an advisory opinion, in accordance with the provisions of this part, within 90 days after it has formally accepted the request for an advisory opinion, or, for requests that CMS determines, in its discretion, involve complex legal issues or highly complicated fact patterns, within a reasonable time period.
