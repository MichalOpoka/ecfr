...
(i) The Part D sponsor's contract or Multi-Contract Entity (MCE) number, (that is, “S” for PDPs, or “Y” for MCE, a means of identification available for Plans/Part D sponsors that have multiple PDP contracts) followed by an underscore, except that the SMID for multi-plan marketing materials must begin with the word “MULTI-PLAN” instead of the Part D sponsor's contract number (for example, S1234\_abc123\_C or MULTI-PLAN\_efg456\_M).
...
(iii) An uppercase “C” for communication materials or an uppercase “M” for marketing materials (for example, S1234\_abc123\_C or S5678\_efg456\_M).
