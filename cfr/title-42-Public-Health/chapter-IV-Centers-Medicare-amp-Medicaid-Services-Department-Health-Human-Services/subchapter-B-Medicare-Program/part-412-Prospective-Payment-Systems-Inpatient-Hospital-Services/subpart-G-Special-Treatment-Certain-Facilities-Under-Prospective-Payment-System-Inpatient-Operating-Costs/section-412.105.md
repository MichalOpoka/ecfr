...
(1) *Step one.* A factor representing the sum of 1.00 plus the hospital's ratio of full-time equivalent residents to beds, as determined under paragraph (a)(1) of this section, is raised to an exponential power equal to the factor set forth in paragraph (c) of this section.
