...
(b) *Amount of reduction to the APC payment.* (1) The amount of the reduction to the APC payment made under paragraphs (a)(1) and (a)(2) of this section is calculated in the same manner as the offset amount that would be applied if the device implanted during a procedure assigned to the APC had transitional pass-through status under § 419.66.
