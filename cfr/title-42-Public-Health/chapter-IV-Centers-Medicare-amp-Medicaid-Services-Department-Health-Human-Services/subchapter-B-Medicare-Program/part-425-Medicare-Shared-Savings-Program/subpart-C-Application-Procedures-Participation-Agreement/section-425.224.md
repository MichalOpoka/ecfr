...
(iv) Whether the ACO met the quality performance standard during at least 1of the first 2 years of the previous agreement period.
...
(c) *Notice of determination.* (1) CMS notifies the ACO in writing of its determination to approve or deny the ACO's renewal request.
