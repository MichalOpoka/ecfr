...
|                                            Work-rate  <br/>test sequence                                             |Duration per cycle (in minutes)|VO<sub>2</sub> (L/min)|VCO<sub>2</sub> (L/min)|Ve (L/min)|RF (breaths/min)|
|----------------------------------------------------------------------------------------------------------------------|-------------------------------|----------------------|-----------------------|----------|----------------|
|                                                       1. Peak                                                        |               5               |         3.00         |         3.20          |   65.0   |       25       |
|                                                       2. High                                                        |              15               |         2.00         |         1.80          |   44.0   |       20       |
|                                                        3. Low                                                        |              10               |         0.50         |         0.40          |   20.0   |       12       |
|VO<sub>2</sub> = volume of oxygen consumed per minute; VCO<sub>2</sub> = volume of carbon dioxide produced per minute.|                               |                      |                       |          |                |
