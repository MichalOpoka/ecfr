...
(b) With the application, the applicant shall provide a statement to the Institute showing the types and results of the examinations, inspections, and tests required under paragraph (a) of this section and state that the respirator meets the minimum requirements of subparts H through KK of this part, as applicable. Complete examination, inspection, and test data shall be retained on file by the applicant and be submitted, upon request, to the Institute.
