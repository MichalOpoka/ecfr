...
(d) *Withdrawal of a direct final rule.* (1) If FMCSA receives an adverse comment or a notice of intent to file an adverse comment within the comment period, it will publish a rule document in the Federal Register, before the effective date of the direct final rule, advising the public and withdrawing the direct final rule.
