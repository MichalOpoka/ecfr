...
S = A1 P / A2Where:S = Tensile stress in psi;A1 = Internal area in cross section of cylinder in square inches;P = Hydrostatic test pressure-psig;A2 = Area of metal in cross section of cylinder in square inches.
...
|Size of specimen (mm)|Average value  <br/>for acceptance  <br/>(3 specimens)|Minimum value  <br/>(1 specimen only  <br/>of the 3)|
|---------------------|------------------------------------------------------|----------------------------------------------------|
