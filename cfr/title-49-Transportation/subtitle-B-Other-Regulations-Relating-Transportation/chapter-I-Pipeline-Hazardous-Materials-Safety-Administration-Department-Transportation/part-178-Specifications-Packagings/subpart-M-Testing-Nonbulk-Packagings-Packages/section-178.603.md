...
|                                                                                           Bags - single-ply with a side seam                                                                                           |Three - (three drops per bag)|                                                                                                             First drop: Flat on a wide face (using all three samples). Second drop: Flat on a narrow face (using all three samples). Third drop: On an end of the bag (using all three samples).                                                                                                             |
|                                                                                  Bags - single-ply without a side seam, or multi-ply                                                                                   | Three - (two drops per bag) |                                                                                                                                           First drop: Flat on a wide face (using all three samples). Second drop: On an end of the bag (using all three samples).                                                                                                                                            |
