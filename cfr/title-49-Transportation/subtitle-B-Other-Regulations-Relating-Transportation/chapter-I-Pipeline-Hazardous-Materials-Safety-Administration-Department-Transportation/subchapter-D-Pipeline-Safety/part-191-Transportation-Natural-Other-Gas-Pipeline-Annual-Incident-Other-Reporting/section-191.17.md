...
(a) *Pipeline systems* - (1) *Transmission or regulated onshore gathering.* Each operator of a transmission or a regulated onshore gathering pipeline system must submit an annual report for that system on DOT Form PHMSA F 7100.2-1. This report must be submitted each year, not later than March 15, for the preceding calendar year.
