...
(c) Each length of pipe with a nominal outside diameter of 41/2 in (114.3 mm) or more must be marked on the pipe or pipe coating with the specification to which it was made, the specified minimum yield strength or grade, and the pipe size. The marking must be applied in a manner that does not damage the pipe or pipe coating and must remain visible until the pipe is installed.
