...
(3) For procedures intended for non-lateral pipe connections, perform testing in accordance with a listed specification. If the test specimen elongates no more than 25% or failure initiates outside the joint area, the procedure qualifies for use.
