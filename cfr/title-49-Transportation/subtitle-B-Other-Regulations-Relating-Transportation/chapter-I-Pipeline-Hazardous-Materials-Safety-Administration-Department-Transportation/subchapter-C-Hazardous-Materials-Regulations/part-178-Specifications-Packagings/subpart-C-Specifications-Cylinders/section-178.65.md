...
S = [P(1.3D2 + 0.4d2)] / (D2 − d2)Where:S = Wall stress, in psi;P = Test pressure in psig;D = Outside diameter, in inches;d = Inside diameter, in inches.

(2) Calculation of the stress for spheres must be made by the following formula:

S = PD / 4tWhere:S = Wall stress, in psi;P = Test pressure i psig;D = Outside diameter, in inches;t = Minimum wall thickness, in inches.
