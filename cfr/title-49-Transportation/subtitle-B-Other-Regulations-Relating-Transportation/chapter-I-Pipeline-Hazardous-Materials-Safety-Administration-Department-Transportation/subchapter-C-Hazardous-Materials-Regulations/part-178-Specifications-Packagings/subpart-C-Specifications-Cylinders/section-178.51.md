...
S = PD / 4tEWhere:S = wall stress in psi;P = minimum test pressure prescribed for water jacket test;D = outside diameter in inches;t = minimum wall thickness in inches;E = 0.85 (provides 85 percent weld efficiency factor which must be applied in the girth weld area and heat affected zones which zone must extend a distance of 6 times wall thickness from center line of weld);E = 1.0 (for all other areas).
