...
S = [P(1.3D2 + 0.4d2)] / (D2 − d2)Where:S = Wall stress in psi;P = Prescribed minimum test pressure in psig (see paragraph (g) of this section);D = Outside diameter in inches; andd = Inside diameter in inches.
