...
*Time to nth stage* means the elapsed time from crash time zero to the deployment command for the nth stage of a frontal air bag (for both driver and right front passenger).
