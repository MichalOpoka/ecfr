...
![](/graphics/er25oc16.307.gif)Where:Fuel Consumption Test Group Resulti = fuel consumption performance for each test group as defined in 49 CFR 523.4.Volumei = production volume of each test group.
