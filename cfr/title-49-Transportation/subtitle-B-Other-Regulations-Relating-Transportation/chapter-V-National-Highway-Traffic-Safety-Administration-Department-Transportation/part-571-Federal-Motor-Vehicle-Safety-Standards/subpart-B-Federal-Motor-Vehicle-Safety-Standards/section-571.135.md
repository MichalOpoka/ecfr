...
S6.5.3.3. In the stopping distance formulas given for each applicable test (such as S≤0.10V + 0.0060V2), S is the maximum stopping distance in meters, and V is the test speed in km/h.
...
(b) Stopping distance for reduced test speed: S≤0.10V + 0.0060V2.
...
(b) Stopping distance for reduced test speed: S ≤0.10V + 0.0075V2.
...
(1) Maintain a constant deceleration rate of 3.0 m/s2 (9.8 fps2).
...
![](/graphics/er02fe95.016.gif)where dc and V are defined in S7.14.4(a).
