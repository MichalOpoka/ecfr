...
When a release mechanism is not located within an occupant space of an adjacent seat, a label meeting the requirements of S5.5.2 that indicates the location of the nearest release mechanism shall be placed within the occupant space.Example:“Emergency Exit Instructions Located Next to Seat Ahead”
