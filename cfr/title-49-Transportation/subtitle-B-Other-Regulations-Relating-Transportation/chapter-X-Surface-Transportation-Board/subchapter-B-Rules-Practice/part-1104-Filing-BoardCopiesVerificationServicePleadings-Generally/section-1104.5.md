...
I \_\_\_\_\_\_\_\_\_\_\_\_\_\_, declare (certify, verify, or state) under penalty of perjury (“under the laws of the United States,” if executed outside of the United States) that the foregoing is true and correct. Further, I certify that I am qualified and authorized to file this (specify type of document). Executed on (*date*).
