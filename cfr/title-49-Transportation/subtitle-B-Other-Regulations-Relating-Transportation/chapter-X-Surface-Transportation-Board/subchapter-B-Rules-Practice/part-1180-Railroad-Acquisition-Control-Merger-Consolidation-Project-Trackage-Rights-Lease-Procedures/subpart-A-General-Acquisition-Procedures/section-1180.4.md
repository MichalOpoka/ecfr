...
(2) The Board will publish a notice in the Federal Register within 30 days of receipt of the applicant's notice. The publication shall contain:
...
(v) In *major* or *significant* transactions, all persons requesting a copy after the prefiling notice is published in the Federal Register.
...
(i) The Board shall accept a complete application no later than 30 days after the application is filed with the Board by publishing a notice in the Federal Register. A complete application contains all information for all applicant carriers required by these procedures, except as modified by advance waiver. The publication shall indicate the applicable time limits for processing the application. (These are the time limits of 49 U.S.C. 11325(b) for a *major* transaction, 49 U.S.C. 11325(c) for a *significant* transaction, and 49 U.S.C. 11325(d) for a *minor* transaction.)
