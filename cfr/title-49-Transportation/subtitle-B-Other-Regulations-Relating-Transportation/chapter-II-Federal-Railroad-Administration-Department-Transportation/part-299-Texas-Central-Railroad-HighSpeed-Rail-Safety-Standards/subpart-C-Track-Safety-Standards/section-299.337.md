...
(3) Calibration procedures and parameters are assigned to the system which assures that measured and recorded values accurately represent track conditions. Track geometry measurements recorded by the system shall not differ on repeated runs at the same site at the same speed more than 3 mm (1/8 inch); and
