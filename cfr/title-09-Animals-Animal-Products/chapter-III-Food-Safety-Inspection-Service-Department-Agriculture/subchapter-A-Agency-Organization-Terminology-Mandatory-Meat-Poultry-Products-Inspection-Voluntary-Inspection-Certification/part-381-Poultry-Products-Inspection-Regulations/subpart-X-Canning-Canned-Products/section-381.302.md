...
(a) *Process schedules.* Prior to the processing of canned product for distribution in commerce, an establishment shall have a process schedule (as defined in § 381.300(n) of this subpart) for each canned poultry product to be packed by the establishment.
