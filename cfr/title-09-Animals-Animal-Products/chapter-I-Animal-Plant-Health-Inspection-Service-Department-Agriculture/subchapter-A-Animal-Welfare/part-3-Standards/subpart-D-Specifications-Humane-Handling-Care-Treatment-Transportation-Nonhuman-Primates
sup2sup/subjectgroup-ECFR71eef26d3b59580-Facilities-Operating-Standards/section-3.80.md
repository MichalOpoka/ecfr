...
(i) The minimum space that must be provided to *each* nonhuman primate, whether housed individually or with other nonhuman primates, will be determined by the typical weight of animals of its species, except for brachiating species and great apes3/\> and will be calculated by using the following table:4/\>
...
|-----|---------|-----------------|---------------|------|-----|--------|
|lbs. |  (kg.)  | ft.<sup>2</sup> |(m<sup>2</sup>)| in.  |(cm.)|        |
