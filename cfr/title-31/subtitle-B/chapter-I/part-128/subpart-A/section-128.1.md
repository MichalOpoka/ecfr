...
(c) *Notice of reports.* Notice of reports required by this part, specification of persons required to file report, and forms to be used to file reports will be published in the Federal Register. Persons currently required to file reports shall continue to file such reports using existing Treasury International Capital Forms BL-1/BL-1(SA), BL-2/BL-2(SA), BL-3, BC/BC(SA), BQ-1, BQ-2, CM, CQ-1, CQ-2, S, and existing Treasury Foreign Currency Forms FC-1, FC-2, FC-3, and FC-4 until further notice is published in the Federal Register.