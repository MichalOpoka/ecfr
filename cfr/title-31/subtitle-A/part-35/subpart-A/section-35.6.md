...
|If a project has total expected  <br/>capital expenditures of |                                    and the use is enumerated in (b)(3), then                                    |                           and the use is not enumerated in (b)(3), then                           |
|--------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
...
*Max {[Base Year Revenue\** (1 + *Growth Adjustment*)^(*n*t*/12)]−Actual General Revenue;* 0}Where:
