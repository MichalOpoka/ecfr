...
\_\_By the end of the base term of the contract or order, and then by the end of each subsequent option period; or

\_\_By the end of the performance period for each order issued under the contract.
