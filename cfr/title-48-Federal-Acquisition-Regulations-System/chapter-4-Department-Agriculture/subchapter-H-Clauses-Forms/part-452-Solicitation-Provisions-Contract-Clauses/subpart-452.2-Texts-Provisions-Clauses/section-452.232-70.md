...
|        Line item         |Description|Total contract value|Funded amount|Unfunded amount|Funding date|
|--------------------------|-----------|--------------------|-------------|---------------|------------|
...
On execution of contract $(month) (day), (year) $(month) (day), (year) $(month) (day), (year) $(End of Clause)