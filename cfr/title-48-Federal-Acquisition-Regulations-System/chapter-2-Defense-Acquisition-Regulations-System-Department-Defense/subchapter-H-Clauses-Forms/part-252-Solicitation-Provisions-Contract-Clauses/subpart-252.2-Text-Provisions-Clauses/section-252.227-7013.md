...
*Alternate I* (JUN 1995). As prescribed in 227.7103-6(b)(1)), add the following paragraph (l) to the basic clause:

(l) *Publication for sale.* (1) This paragraph only applies to technical data in which the Government has obtained unlimited rights or a license to make an unrestricted release of technical data.
