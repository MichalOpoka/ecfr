...
(2) *Government purpose rights.* (i) Except as provided in paragraph (b)(1) of this clause, the Government shall have government purpose rights in computer software development with mixed funding.
...
(e) *Identification and delivery of computer software and computer software documentation to be furnished with restrictions on use, release, or disclosure.* (1) This paragraph does not apply to restrictions based solely on copyright.
...
(4) *Special license rights markings.* (i) Computer software or computer documentation in which the Government's rights stem from a specifically negotiated license shall be marked with the following legend:
...
*Alternate I* (JUN 1995). As prescribed in 227.7203-6(a)(2), add the following paragraph (l) to the basic clause:

(l) *Publication for sale.* (1) This paragraph only applies to computer software or computer software documentation in which the Government has obtained unlimited rights or a license to make an unrestricted release of the software or documentation.
