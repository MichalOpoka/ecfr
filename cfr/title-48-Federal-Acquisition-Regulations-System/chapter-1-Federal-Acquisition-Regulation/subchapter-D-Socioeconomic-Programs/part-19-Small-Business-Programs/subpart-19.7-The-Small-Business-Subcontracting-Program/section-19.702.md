...
(iii) Each contract modification that causes the value of a contract without a subcontracting plan to exceed $700,000 ($1.5 million for construction), shall require the contractor to submit a subcontracting plan for the contract, if the contracting officer determines that subcontracting opportunities exist. For a multiple-award contract with more than one NAICS code, see paragraph (a)(2)(ii) of this section.
