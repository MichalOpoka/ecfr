...
(1) For items shipped to consignees, the Contractor shall include a copy of the MSDS with the packing list or other suitable shipping document which accompanies each shipment. Alternatively, the Contractor is permitted to transmit MSDS's to consignees in advance of receipt of shipments by consignees, if authorized in writing by the Contracting Officer.
