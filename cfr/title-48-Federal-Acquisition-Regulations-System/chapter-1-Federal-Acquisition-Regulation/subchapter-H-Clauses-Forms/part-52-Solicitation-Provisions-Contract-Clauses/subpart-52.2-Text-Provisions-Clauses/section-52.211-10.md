...
The completion date is based on the assumption that the successful offeror will receive the notice to proceed by \_\_ [*Contracting Officer insert date*]. The completion date will be extended by the number of calendar days after the above date that the Contractor receives the notice to proceed, except to the extent that the delay in issuance of the notice to proceed results from the failure of the Contractor to execute the contract and give the required performance and payment bonds within the time specified in the offer.
