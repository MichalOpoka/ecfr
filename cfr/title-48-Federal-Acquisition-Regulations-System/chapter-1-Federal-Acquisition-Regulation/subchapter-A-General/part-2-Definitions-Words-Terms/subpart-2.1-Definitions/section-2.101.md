...
*Signature* or *signed* means the discrete, verifiable symbol of an individual which, when affixed to a writing with the knowledge and consent of the individual, indicates a present intention to authenticate the writing. This includes electronic symbols.
