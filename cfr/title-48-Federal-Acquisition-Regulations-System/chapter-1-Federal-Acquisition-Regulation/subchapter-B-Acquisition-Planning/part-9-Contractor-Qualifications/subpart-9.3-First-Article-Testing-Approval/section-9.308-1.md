...
(b)(1) The contracting officer shall insert a clause substantially the same as the clause at 52.209-3, First Article Approval - Contractor Testing, in solicitations and contracts when a cost-reimbursement contract is contemplated and it is intended that the contract require (i) first article approval and (ii) that the contractor be required to conduct the first article test.
