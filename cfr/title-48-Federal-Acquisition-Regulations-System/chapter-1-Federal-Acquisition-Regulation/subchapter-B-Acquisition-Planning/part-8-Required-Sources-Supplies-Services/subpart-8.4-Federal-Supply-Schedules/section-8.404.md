...
(2) For orders over $550,000, *see* subpart 17.5 for additional requirements for interagency acquisitions. For example, the requiring agency shall make a determination that use of the Federal Supply Schedule is the best procurement approach, in accordance with 17.502-1(a).
