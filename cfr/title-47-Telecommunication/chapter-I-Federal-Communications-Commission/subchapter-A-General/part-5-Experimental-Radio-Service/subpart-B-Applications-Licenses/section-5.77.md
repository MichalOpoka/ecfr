...
(b) For conventional experimental radio stations, the changes permitted in paragraph (a) of this section may be made without prior authorization from the Commission provided that the license supplements its application file with a description of such change. If the licensee wants these emission changes to become a permanent part of the license, an application for modification must be filed.
