...
Transmitter output power = Ep × Ip × *F*Where:Ep = DC input voltage of the final radio-frequency amplifier stage.Ip = DC input current of the final radio-frequency amplifier stage.*F* = Efficiency factor.
