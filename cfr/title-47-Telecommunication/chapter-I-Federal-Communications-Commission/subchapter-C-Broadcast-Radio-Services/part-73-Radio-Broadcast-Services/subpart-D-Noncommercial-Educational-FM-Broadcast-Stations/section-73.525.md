...
Co-channel, normal offset, −22 dBCo-channel, no offset, −39 dBAdjacent channel, + 12 dB
...
[H + (V/A)] is no greater than PWhere:H is the horizontally polarized ERP in kilowatts for mixed polarity;V is the vertically polarized ERP in kilowatts for mixed polarity;A is 40 if the predicted interference area lies entirely outside the limits of a city of 50,000 persons or more, or 10 if it does not; andP is the maximum permitted horizontally polarized-only power in kilowatts.
