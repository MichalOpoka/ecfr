...
![](/graphics/er17no94.007.gif)where d is the radial distance to the boundary, in kilometersp is the radial effective radiated power, in kilowattsThe maximum effective radiated power in the pertinent direction, without consideration of the antenna's vertical radiation pattern or height, must be used in the formula.
