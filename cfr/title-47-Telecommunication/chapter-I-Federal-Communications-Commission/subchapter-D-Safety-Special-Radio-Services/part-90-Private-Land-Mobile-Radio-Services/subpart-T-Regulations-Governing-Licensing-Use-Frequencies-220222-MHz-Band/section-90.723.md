...
|                                                            Separation distance (kilometers)                                                            |Radiated power (watts) <sup>1</sup>|
|--------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|
|                                                                        0.0-0.3                                                                         |          (<sup>2</sup>)           |
|                                                                        0.3-0.5                                                                         |                 5                 |
|                                                                        0.5-0.6                                                                         |                10                 |
...
|                                                                        5.0-6.0                                                                         |                200                |
|                                                                        Over 6.0                                                                        |                500                |
|                           <sup>1</sup> Transmitter peak envelope power shall be used to determine effective radiated power.                            |                                   |
|<sup>2</sup> Stations separated by 0.3 km or less shall not be authorized. This table does not apply to the low-power channels 196-200. See § 90.729(c).|                                   |
