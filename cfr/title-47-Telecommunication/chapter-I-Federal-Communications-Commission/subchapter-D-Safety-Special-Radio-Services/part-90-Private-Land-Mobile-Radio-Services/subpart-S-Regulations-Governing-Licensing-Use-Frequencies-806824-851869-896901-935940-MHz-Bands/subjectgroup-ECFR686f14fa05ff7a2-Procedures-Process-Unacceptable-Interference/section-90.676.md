...
(6) Notify the Commission when band reconfiguration is complete in each 800 MHz NPSPAC Region and identify which vacant channels are exclusively available to eligible applicants in the Public Safety or Critical Infrastructure Industry Categories as set forth in §§ 90.615(a), (b) and 90.617(g), (h).
