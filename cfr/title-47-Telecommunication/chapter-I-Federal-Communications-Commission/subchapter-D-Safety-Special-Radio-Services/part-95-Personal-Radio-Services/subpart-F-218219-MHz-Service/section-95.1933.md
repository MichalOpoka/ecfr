...
(b) Each 218-219 MHz Service licensee must file a report to inform the Commission of the service status of its system. The report must be labeled as an exhibit to the renewal application. At minimum, the report must include:
