...
|                           Category of vessel                            |Minimum class of FCC license required by private sector technician to conduct  <br/>inspection—only one license required|                                                                                             |                                                  |   |
|-------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|--------------------------------------------------|---|
|             General radiotele-phone operator  <br/>license              |                                      GMDSS radio  <br/>maintainer's  <br/>license                                      |Radiotelegraph operator license (formerly second class radiotelegraph operator's certificate)|First class radiotelegraph operator's certificate.|   |
