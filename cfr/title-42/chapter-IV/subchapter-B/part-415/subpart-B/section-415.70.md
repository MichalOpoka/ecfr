...
(f) *Notification of changes in methodologies and payment limits.* (1) Before the start of a cost reporting period to which limits established under this section will be applied, CMS publishes a notice in the Federal Register that sets forth the amount of the limits and explains how it calculated the limits.
