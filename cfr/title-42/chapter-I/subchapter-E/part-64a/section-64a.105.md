...
![](/graphics/ec13no91.004.gif)whereA = the amount the United States is entitled to recover;θ = the cost of the clinical traineeship (including stipends and other trainee allowances);m = the number of months since the trainee failed to perform obligated service;i = the National Research Service Award rate on the date which the period of appointment begins divided by twelve;t = the total number of months of the service obligation;s = the number of months that have been served.
