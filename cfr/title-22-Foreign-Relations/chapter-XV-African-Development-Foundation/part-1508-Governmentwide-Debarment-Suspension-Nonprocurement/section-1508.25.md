...
|       B        |        the types of ADF transactions that are covered by the Governmentwide nonprocurement suspension and debarment system.        |
|       C        |                              the responsibilities of persons who participate in covered transactions.                              |
|       D        |                    the responsibilities of ADF officials who are authorized to enter into covered transactions.                    |
...
|(6) a (n) ADF official authorized to enter into a covered transaction|   A, B, D, E and I.   |
|                            (7) Reserved                             |          J.           |