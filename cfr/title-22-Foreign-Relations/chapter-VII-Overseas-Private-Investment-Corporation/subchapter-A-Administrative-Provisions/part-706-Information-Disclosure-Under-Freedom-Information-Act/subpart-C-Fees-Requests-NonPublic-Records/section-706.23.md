...
(g) *Advance payments.* (1) For requests other than those described in paragraphs (g)(2) and (3) of this section OPIC will not require the requester to make an advance payment before work is commenced or continued on a request. Payment owed for work already completed (*i.e.,* payment before copies are sent to a requester) is not an advance payment.
