...
(ix) For a work published after January 1, 1978, the only claimant given on the application was deceased on the date the application was certified;

(x) A work is not anonymous or pseudonymous and statements on the application and/or copy vary so much that the author cannot be identified; and
