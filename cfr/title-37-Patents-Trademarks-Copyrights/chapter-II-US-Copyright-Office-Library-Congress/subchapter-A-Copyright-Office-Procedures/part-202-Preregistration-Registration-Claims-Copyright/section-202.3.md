...
Link to an amendment published at 83 FR 2547, Jan. 18, 2018.
...
(D) Deposit materials in support of an online application may be submitted electronically in a digital format (if eligible) along with the application and payment, or an applicant may send physical copies or phonorecords as necessary to satisfy the best edition requirements, by mail to the Copyright Office, using the required shipping slip generated during the online registration process.
