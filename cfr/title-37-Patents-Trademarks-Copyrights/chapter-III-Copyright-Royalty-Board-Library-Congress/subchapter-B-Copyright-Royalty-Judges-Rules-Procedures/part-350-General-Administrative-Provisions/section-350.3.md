...
(3) *Proposed orders; file type.* Parties filing a proposed order as required by § 350.4 must prepare the proposed order as a separate Word document and submit it together with the main pleading.
