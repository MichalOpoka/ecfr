...
|                                                                                                                Clear length                                                                                                                |       600       |
|                                                                                                                Clear width                                                                                                                 |       80        |
|                                                                                                              Depth over sills                                                                                                              |<sup>1</sup> 24.4|
|<sup>1</sup> This depth is below Chicago City Datum which is the zero of the gages mounted on the lock. The clear depth below Low Water Datum for Lake Michigan, which is the plane of reference for U. S. Lake Survey Charts, is 23.0 feet.|                 |
