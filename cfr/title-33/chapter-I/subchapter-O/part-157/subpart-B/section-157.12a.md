...
*Control unit* means a device that receives automatic signals of oil content of the effluent ppm, flow rate of discharge m3/hour, ship's speed in knots, ship's position-latitude and longitude, date and time (GMT, Greenwich Mean Time), and status of the overboard discharge control. The control unit makes automatic recordings of data as specified in § 157.12d(h)(2).
