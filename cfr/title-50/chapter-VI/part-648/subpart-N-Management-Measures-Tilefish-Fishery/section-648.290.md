...
(2) *Periodicity.* The tilefish commercial ACL may be established on an annual basis for up to 3 years at a time, dependent on whether the SSC provides single or multiple-year ABC recommendations.

(b) *Performance review.* The Tilefish Monitoring Committee shall conduct a detailed review of fishery performance relative to the sector ACLs at least every 5 years.
...
(2) The MAFMC may specify more frequent or more specific ACL performance review criteria as part of a stock rebuilding plan following a determination that the tilefish stock has become overfished.
