...
(3) A description of the factors affecting the presence and distribution of sea otters (*e.g.,* weather, sea state, and project activities). An estimate will be included of the number of sea otters exposed to noise at received levels greater than or equal to 160 dBRMS re: 1 µPa (decibels root-mean squared referenced to 1 microPascal) (based on visual observation).
...
(d) All reports must be submitted by email to *fw7\_mmm\_reports@fws.gov.*
