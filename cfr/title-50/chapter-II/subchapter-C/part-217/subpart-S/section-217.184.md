...
(b) *Deep penetration surveys.* (1) Deep penetration surveys are defined as surveys using airgun arrays with total volume greater than 1,500 in3.
...
(c) *Shallow penetration surveys.* (1) Shallow penetration surveys are defined as surveys using airgun arrays with total volume equal to or less than 1,500 in3, single airguns, boomers, or equivalent sources.
