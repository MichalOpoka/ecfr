...
Table 1—B. \_\_\_\_Estimated Cost—Incrementally Funded Contract

(a) The total estimated cost to the Government for full performance of this contract, including all allowable direct and indirect costs, is $\_\_\_\_ [*insert full amount*].

(b) The following represents the schedule\* by which the Government expects to allot funds to this contract:

|CLIN,  <br/>task number, or  <br/>description|Start date of  <br/>increment of  <br/>performance|End date of  <br/>increment of  <br/>performance|Estimated cost ($)|Fee ($)  <br/>(as appropriate)|Estimated cost  <br/>plus fee  <br/>($) (as appropriate)|
|---------------------------------------------|--------------------------------------------------|------------------------------------------------|------------------|------------------------------|--------------------------------------------------------|
|                                             |                                                  |                                                |                  |                              |                                                        |
|                                             |                                                  |                                                |                  |                              |                                                        |
|                                             |                                                  |                                                |                  |                              |                                                        |
...
(c) Total funds currently obligated and available for payment under this contract are $\_\_\_\_ [*insert amount funded to date*].
