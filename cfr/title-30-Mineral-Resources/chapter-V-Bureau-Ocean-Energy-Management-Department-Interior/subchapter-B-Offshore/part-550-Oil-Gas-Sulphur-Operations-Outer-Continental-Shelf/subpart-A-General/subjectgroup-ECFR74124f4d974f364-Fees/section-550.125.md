...
|                                         (3) [Reserved]                                         |                                                      |               |
|                                   (4) Exploration Plan (EP)                                    |$3,442 for each surface location; no fee for revisions| § 550.211(d). |
|(5) Development and Production Plan (DPP) or Development Operations Coordination Document (DOCD)| $3,971 for each well proposed; no fee for revisions  | § 550.241(e). |
|                                         (6) [Reserved]                                         |                                                      |               |
