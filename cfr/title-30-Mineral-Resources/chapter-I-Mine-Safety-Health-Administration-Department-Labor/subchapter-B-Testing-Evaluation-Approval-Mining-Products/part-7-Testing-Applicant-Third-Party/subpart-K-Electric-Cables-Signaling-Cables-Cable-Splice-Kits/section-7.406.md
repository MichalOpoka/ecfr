...
(b) *Specimen holder (support).* A specimen holder (support) consisting of three separate metal rods each measuring approximately3/16 inch in diameter (nominal) to support the specimen. The horizontal portion of the rod which contacts the test specimen shall be approximately 12 inches in length.

(c) *Gas ignition source.* A standard natural gas type Tirrill burner, with a nominal inside diameter of3/8 inch, to apply the flame to the test specimen. The fuel for the burner shall be natural gas composed of at least 96 percent combustible hydrocarbons, with at least 80 percent being methane.
