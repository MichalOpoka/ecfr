...
![](/graphics/er10ja96.006.gif)Where:cm = Circular-mil area of conductor.K = 3.28 ohms/mil-meter (metric)K = 10.75 ohms/mil-foot (english)(a constant representing the resistance of cooper).I = Load current, in amperes.L = length of conductor from center of distribution, in meters (feet).E = Voltage drop at load, in volts.
