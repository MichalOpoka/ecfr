...
i = [h − 4]0.04q, (i = [h − 1.722].04q, for metric units), where:i = increase in freeing port area, in square feet (square meters);h = bulwark height, in feet (meters); andq = length of bulwark exceeding 4 feet (1.22 meters) in height, in feet (meters).
...
r = [3 − h]0.04q, (r = [h − 0.91 − h]0.04q), where:r = permitted reduction in freeing port area, in square feet (square meters).h = bulwark height, in feet (meters).q = length of bulwark which is less than 3 feet (0.914 meters) in height, in feet (meters).
