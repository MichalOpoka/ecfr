...
EFI = I × (tc − ti) / 0.2 + (tc − ti)Where:I is the measured intensity of the fixed beam,tc is the contact closure time in seconds, (0.33 for this S-O-S signal), andti is the incandescence time of the lamp in seconds.
