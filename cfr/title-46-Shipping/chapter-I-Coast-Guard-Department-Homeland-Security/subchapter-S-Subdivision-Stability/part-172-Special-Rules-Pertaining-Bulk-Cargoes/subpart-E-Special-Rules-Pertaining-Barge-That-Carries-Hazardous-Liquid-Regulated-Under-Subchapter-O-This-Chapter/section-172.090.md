...
![](/graphics/ec01mr91.025.gif)where—K = 0.3 for river service.K = 0.4 for lakes, bays and sounds and Great Lakes summer service.K = 0.5 for ocean and Great Lakes winter service.B = beam in feet (meters).fe = effective freeboard in feet (meters).

(c) The effective freeboard is given by—

fe = f + fa ; orfe = d, whichever is less.where—f = the freeboard to the deck edge amidships in feet (meters).fa = (1.25)(a/L)((2b/B)-1)(h); orfa = h, whichever is less.where—a = trunk length in feet (meters).L = LOA in feet (meters)b = breadth of a watertight trunk in feet (meters).B = beam of the barge in feet (meters).h = height of a watertight trunk in feet (meters).d = draft of the barge in feet (meters).
