...
q = 3.89(i)(n).where: q = quantity of expelled air in cubic feet per hour.i = Maximum charging current during gas formation, or one-fourth of the maximum obtainable charging current of the charging facility, whichever is greater.n = Number of cells.
