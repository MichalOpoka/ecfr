...
(p) During each internal inspection, each cargo tank must be tested hydrostatically to 11/2 times the maximum allowable pressure as determined by the safety relief valve setting.
