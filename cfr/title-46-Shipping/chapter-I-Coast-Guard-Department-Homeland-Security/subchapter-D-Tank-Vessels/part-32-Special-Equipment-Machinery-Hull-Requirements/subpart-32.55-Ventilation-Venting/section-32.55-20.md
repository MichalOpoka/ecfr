...
(a) *Venting required.* (1) On all tankships, the construction or conversion of which is started on or after July 1, 1951, each cargo tank shall be equipped with a vent. The diameter of a vent shall be not less than 21/2 inches.
