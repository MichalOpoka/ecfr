...
(b) *Combined waste receipts from subparts A, B and C of this part:* Limitations for BOD5, O&G, pH, and TSS are the same as the corresponding limitation specified in § 437.42(b).
...
(d) *Combined waste receipts from subparts A and C of this part:* Limitations for BOD5, O&G, pH, and TSS are the same as the corresponding limitation specified in § 437.42(d).

(e) *Combined waste receipts from subparts B and C of this part:* Limitations for BOD5, O&G, pH, and TSS are the same as the corresponding limitation specified in § 437.42(e).