...
|Loaded vehicle mass (kg)|Equivalent inertial mass (kg)|Force coefficients|Force at 65 km/h (nt)|70 to 60 km/h coastdown calibration times|     |    |    |
|------------------------|-----------------------------|------------------|---------------------|-----------------------------------------|-----|----|----|
|         A (nt)         |  C (nt/(km/h)<sup>2</sup>)  |Target time (sec) | Allowable tolerance |                                         |     |    |    |
|   Longest time (sec)   |     Shortest time (sec)     |                  |                     |                                         |     |    |    |
