...
![](/graphics/er21my21.004.gif)Where:MNMOC = Total NMOC emission rate from the landfill, megagrams per year.k = Methane generation rate constant, year−1.Lo = Methane generation potential, cubic meters per megagram solid waste.Mi = Mass of solid waste in the ith section, megagrams.ti = Age of the ith section, years.CNMOC = Concentration of NMOC, parts per million by volume as hexane.3.6 × 10−9 = Conversion factor.
...
![](/graphics/er21my21.005.gif)Where:MNMOC = Mass emission rate of NMOC, megagrams per year.Lo = Methane generation potential, cubic meters per megagram solid waste.R = Average annual acceptance rate, megagrams per year.k = Methane generation rate constant, year −1.t = Age of landfill, years.CNMOC = Concentration of NMOC, parts per million by volume as hexane.c = Time since closure, years; for an active landfill c = 0 and e−kc = 1.3.6 × 10−9 = Conversion factor.
...
![](/graphics/er21my21.006.gif)Where:MNMOC = Mass emission rate of NMOC, megagrams per year.QLFG = Flow rate of landfill gas, cubic meters per minute.CNMOC = NMOC concentration, parts per million by volume as hexane.
...
![](/graphics/er21my21.007.gif)Where:NMOCin = Mass of NMOC entering control device.NMOCout = Mass of NMOC exiting control device.
