...
*Product-Weighted Reactivity (PWR) Limit* means the maximum allowed “product- weighted reactivity,” as calculated in § 59.505, of an aerosol coating product that is subject to the limits specified in § 59.504 for a specific category, expressed as grams of ozone per gram of product (g O3/g product).
