...
Equation 7![](/graphics/er18jy97.100.gif)where:i = replicate number;j = isokinetic sampler number;Miso = mass of material collected with the isokinetic sampler;Q = isokinetic sampler volumetric flow rate; andt = sampling time.

(iii) Calculate and record the mean mass concentration as:

Equation 8![](/graphics/er18jy97.101.gif)where:i = replicate number;j = isokinetic sampler number; andn = total number of isokinetic samplers.

(iv) Precision calculation. (A) Calculate the coefficient of variation of the mass concentration measurements as:

Equation 9![](/graphics/er18jy97.102.gif)where:i = replicate number;j = isokinetic sampler number; andn = total number of isokinetic samplers.
...
Equation 10![](/graphics/er18jy97.103.gif)where:i = replicate number;Mcand = mass of material collected with the candidate sampler;Q = candidate sampler volumetric flow rate; andt = sampling time.

(iv)(A) Calculate and record the sampling effectiveness of the candidate sampler as:

Equation 11![](/graphics/er18jy97.104.gif)where:i = replicate number.
...
Equation 12![](/graphics/er18jy97.105.gif)where:i = replicate number; andn = number of replicates.
...
Equation 13![](/graphics/er18jy97.106.gif)where:i = replicate number, andn = number of replicates.
...
Equation 14![](/graphics/er18jy97.107.gif)where:Ccand(est) = estimated mass concentration measurement for the test sampler, µg/m3; andCref(est) = estimated mass concentration measurement for the reference sampler, µg/m3 (calculated for the reference sampler and specified at the bottom of column 7 of table F-4 of this subpart).
