...
Equation 15![](/graphics/er18jy97.108.gif)where:i = replicate number;Mref = mass of material collected with the reference method sampler;Q = reference method sampler volumetric flow rate; andt = sampling time.
...
Equation 16![](/graphics/er18jy97.109.gif)where:i = replicate number;Mcand = mass of material collected with the candidate sampler;Q = candidate sampler volumetric flow rate; andt = sampling time.
...
Equation 17![](/graphics/er18jy97.110.gif)where:i = replicate number.

(ii) Calculate and record the mean aspiration ratio as:

Equation 18![](/graphics/er18jy97.111.gif)where:i = replicate number; andn = total number of measurements of aspiration ratio.
...
Equation 19![](/graphics/er18jy97.112.gif)where:i = replicate number; andn = total number of measurements of aspiration ratio.
