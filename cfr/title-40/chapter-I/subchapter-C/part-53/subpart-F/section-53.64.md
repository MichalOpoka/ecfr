...
Equation 20![](/graphics/er18jy97.113.gif)where:i = replicate number;Mcand = mass of material collected with the candidate sampler;Q = candidate sampler volumetric flowrate; andt = sampling time.
...
Equation 21![](/graphics/er18jy97.114.gif)where:i = replicate number;Mwash = mass of material washed from the interior surfaces of the fractionator;Q = candidate sampler volumetric flowrate; andt = sampling time.

(iv) Calculate and record the sampling effectiveness of the test sampler for this particle size as:

Equation 22![](/graphics/er18jy97.115.gif)where:i = replicate number.
...
Equation 23![](/graphics/er18jy97.116.gif)where:i = replicate number; andn = number of replicates.
...
Equation 24![](/graphics/er18jy97.117.gif)where:i = replicate number; andn = total number of measurements.
...
Equation 25![](/graphics/er18jy97.118.gif)where:i = replicate number;j = total filter sampler number;Mtotal = mass of material collected with the total filter sampler;Q = total filter sampler volumetric flowrate; andt = sample time.

(ii) Calculate and record the mean mass concentration as:

Equation 26![](/graphics/er18jy97.119.gif)where:n = total number of samplers;i = replicate number; andj = filter sampler number.

(iii) (A) Calculate and record the coefficient of variation of the total mass concentration as:

Equation 27![](/graphics/er18jy97.120.gif)where:i = replicate number;j = total filter sampler number; andn = number of total filter samplers.
...
Equation 28![](/graphics/er18jy97.121.gif)where:i = replicate number;Mcand = mass of material collected with the candidate sampler;Q = candidate sampler volumetric flowrate; andt = sample time.

(ii) Calculate and record the sampling effectiveness of the candidate sampler as:

Equation 29![](/graphics/er18jy97.122.gif)where:i = replicate number.
...
Equation 30![](/graphics/er18jy97.123.gif)where:i= replicate number.
...
Equation 31![](/graphics/er18jy97.124.gif)where:i = replicate number; andn = number of measurements of effectiveness.
...
Equation 32![](/graphics/er18jy97.125.gif)where:i = replicate number,M = mass of material collected with the total filter; andQ = candidate sampler volumetric flowrate.
...
Equation 33![](/graphics/er18jy97.126.gif)Equation 34![](/graphics/er18jy97.127.gif)where:i = replicate number; andn = number of replicates.
...
Equation 35![](/graphics/er18jy97.128.gif)Equation 36![](/graphics/er18jy97.129.gif)where:i = replicate number.
...
Equation 37![](/graphics/er18jy97.130.gif)where:i = replicate number.
...
Equation 38![](/graphics/er18jy97.131.gif)where:i = replicate number.
...
Equation 39![](/graphics/er18jy97.132.gif)where:i = replicate number; andn = number of replicates.
