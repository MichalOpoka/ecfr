...
(2) For units that the owner or operator intends to monitor for NOX mass emissions using a NOX concentration monitoring system and a flow monitoring system, the maximum potential concentration of NOX and the maximum potential flow rate, as defined in section 2.1.4.1 of appendix A to this part;
