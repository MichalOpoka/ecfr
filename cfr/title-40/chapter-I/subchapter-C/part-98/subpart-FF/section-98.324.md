...
![](/graphics/er29no11.000.gif)Where:CCH4 = Methane (CH4) concentration in the gas (volume %) for use in Equations FF-1 and FF-3 of this subpart.fNMOC = Correction factor from the most recent determination of the correction factor as specified in paragraph (d)(2)(ii) of this section (unitless).CTGOC = Gaseous organic carbon concentration measured using Method 25A or 25B at 40 CFR part 60, appendix A-7 during routine monitoring of the gas (volume %).
