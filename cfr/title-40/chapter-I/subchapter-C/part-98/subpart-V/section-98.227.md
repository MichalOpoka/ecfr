...
(7) Destruction efficiency of N2O abatement technology that is used on each nitric acid train (decimal fraction of N2O removed from vent stream) (Equation V-3a of § 98.223).

(8) Destruction efficiency of each N2O abatement technology that is used on each nitric acid train (decimal fraction of N2O removed from vent stream) (Equation V-3b of § 98.223).

(9) Destruction efficiency of each N2O abatement technology that is used on each nitric acid train (decimal fraction of N2O removed from vent stream) (Equation V-3c of § 98.223).
