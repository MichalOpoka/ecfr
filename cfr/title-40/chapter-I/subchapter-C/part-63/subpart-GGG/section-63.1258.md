...
![](/graphics/er29au00.011.gif)Where: Fs = system flowrate setpoint, scfm Ean = annual emissions entering the control device, lbmols/yr
...
![](/graphics/er29au00.012.gif)Where: Ca = adjusted outlet concentration limit, dry basis, ppmv 50 = outlet concentration limit associated with the flowrate setpoint, dry basis, ppmv Fs = system flowrate setpoint, scfm Fa = actual system flowrate limit, scfm
