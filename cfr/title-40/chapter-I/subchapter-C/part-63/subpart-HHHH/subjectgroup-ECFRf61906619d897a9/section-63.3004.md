...
T = L/SWhere:T is the residence time, in seconds;L is the length of the drying and curing oven, in feet; andS is the slowest line speed normally operated on the line, excluding periods of ramping up to speed during startup, in feet per second.
