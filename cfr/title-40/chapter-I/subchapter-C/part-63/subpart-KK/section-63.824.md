...
(F) Calculate the overall effective organic HAP control efficiency (Re) for the month using Equation 1:

![](/graphics/er30my96.000.gif)For the purposes of this calculation, the mass fraction of organic HAP present in the recovered volatile matter is assumed to be equal to the mass fraction of organic HAP present in the volatile matter used.
...
(C) Calculate the overall effective organic HAP control efficiency (Re) achieved for each month using Equation 2.

![](/graphics/er30my96.001.gif)
...
(E) The affected source is in compliance with the requirement for the month if Re is at least 92 percent, and the capture device is operated at an average value greater than, or less than (as appropriate) the operating parameter value established in accordance with § 63.828(a)(5) for each three-hour period.
