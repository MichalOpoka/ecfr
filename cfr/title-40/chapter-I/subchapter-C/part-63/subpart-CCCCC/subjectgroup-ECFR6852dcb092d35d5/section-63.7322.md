...
Equation 1 to Paragraph (b)(4)![](/graphics/er05jy24.003.gif)Where:Ep, PM = Process weighted mass emissions of particulate matter, lb/ton;CPM = Concentration of particulate matter, gr/dscf;Q = Volumetric flow rate of stack gas, dscf/hr;Θ = Total sampling run time; the time during a run that a sample is withdrawn from the stack during pushing, hr;P = Total amount of coke pushed during the test run, tons; andK = Conversion factor, 7,000 gr/lb.
...
Equation 2 to Paragraph (c)(4)![](/graphics/er05jy24.004.gif)Where:Ep,Hg = Process weighted mass emissions of mercury, lb/ton;CHg = Concentration of mercury, gr/dscf;Q = Volumetric flow rate of stack gas, dscf/hr;Θ = Total sampling run time; the time during a run that a sample is withdrawn from the stack, for capture systems and control devices applied to pushing emissions, total time during a run that a sample is withdrawn from the stack during pushing, hr;P = Total amount of coke pushed during the test run, tons; andK = Conversion factor, 7,000 gr/lb.
...
Equation 3 to Paragraph (d)((1)(ii)(C)Reported Results = ((Measured Concentration in Stack)/(% R)) × 100.
...
Equation 4 to Paragraph (d)(4)![](/graphics/er05jy24.005.gif)Where:Ep,AG = Process weighted mass emissions of total acid gases, lb/ton;CAG = Concentration of total acid gases, gr/dscf;Q = Volumetric flow rate of stack gas, dscf/hr;Θ = Total sampling run time; the time during a run that a sample is withdrawn from the stack, for capture systems and control devices applied to pushing emissions, total time during a run that a sample is withdrawn from the stack during pushing, hr;P = Total amount of coke pushed during the test run, tons; andK = Conversion factor, 7,000 gr/lb.
...
Equation 5 to Paragraph (e)(1)(ii)(C)Reported Results = ((Measured Concentration in Stack)/(% R)) × 100.
...
Equation 6 to Paragraph (e)(4)![](/graphics/er05jy24.006.gif)Where:Ep,HCN = Process weighted mass emissions of hydrogen cyanide, lb/ton;CHCN = Concentration of hydrogen cyanide, gr/dscf;Q = Volumetric flow rate of stack gas, dscf/hr;Θ = Total sampling run time; the time during a run that a sample is withdrawn from the stack, for capture systems and control devices applied to pushing emissions, total time during a run that a sample is withdrawn from the stack during pushing, hr;P = Total amount of coke pushed during the test run, tons; andK = Conversion factor, 7,000 gr/lb.
...
Equation 7 to Paragraph (f)(4)![](/graphics/er05jy24.007.gif)Where:Ep,PAH = Process weighted mass emissions of total PAH, lb/ton;CPAH = Concentration of each PAH, gr/dscf;Q = Volumetric flow rate of stack gas, dscf/hr;Θ = Total sample run time; the time during a run that a sample is withdrawn from the stack during pushing, hr;P = Total amount of coke pushed during the test run, tons; andK = Conversion factor, 7,000 gr/lb.
...
Equation 8 to Paragraph (g)(1)(ii)(C)Reported Results = ((Measured Concentration in Stack)/(% R)) × 100.
