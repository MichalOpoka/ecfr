...
![](/graphics/er13no03.019.gif)Where:CE = Capture efficiency of the emission capture system vented to the add-on control device, percent. TVHused = Total mass of liquid TVH used in the coating operation during the capture efficiency test run, kg. TVHuncaptured = Total mass of TVH that is not captured by the emission capture system and that exits from the TTE or building enclosure during the capture efficiency test run, kg, determined according to paragraph (c)(4) of this section.
