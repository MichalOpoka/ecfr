...
![](/graphics/er18se15.010.gif)Where:Eday = The daily PM, HCl, and D/F (and HF for uncontrolled group 1 furnaces) emission rate for the secondary aluminum processing unit for the 24-hour period;Ti = The total amount of feed, or aluminum produced, for emission unit i for the 24-hour period (tons or Mg);ERi = The measured emission rate for emission unit i as determined in the performance test (lb/ton or µg/Mg of feed/charge); andn = The number of emission units in the secondary aluminum processing unit.
