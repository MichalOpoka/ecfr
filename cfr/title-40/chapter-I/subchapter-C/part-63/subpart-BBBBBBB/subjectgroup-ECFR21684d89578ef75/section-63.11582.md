...
RE = [1 − (Ci − Co)/Ci]\*100Where:RE = PM removal efficiency, percent.Ci = Concentration of PM at inlet of control device, gr/dscf.Co = Concentration of PM at outlet of control device, gr/dscf.
...
RE = [1 − (Qi − Qo)/Qi]\*100Where:RE = Annual average PM removal efficiency, percent.Qi = Annual amount of PM in uncontrolled emissions, pounds per year.Qo = Annual amount of PM captured by control device, pounds per year.
...
PC = [Qi − Qo]\*7000/DCFM\*MPYWhere:PC = Annual average PM concentration, grains per dry standard cubic foot (gr/dscf).Qi = Annual amount of PM in uncontrolled emissions, pounds per year.Qo = Annual amount of PM captured by control device, pounds per year. (Qo is equal to zero if the process vent stream is not routed to a control device.)DCFM = Process vent stream flowrate, dscf per minute (dscfm).MPY = Minutes per year equipment are in target HAP service.
