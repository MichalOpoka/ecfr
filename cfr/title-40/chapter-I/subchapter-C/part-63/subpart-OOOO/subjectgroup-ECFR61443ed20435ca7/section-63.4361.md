...
![](/graphics/er29my03.028.gif)Where:TVHapplied = Mass of liquid TVH in regulated materials applied in the web coating/printing or dyeing/finishing operation during the capture efficiency test run, kg.TVHi = Mass fraction of TVH in regulated material, i, that is applied in the web coating/printing or dyeing/finishing operation during the capture efficiency test run, kg TVH per kg material.Mi = Total mass of regulated material, i, applied in the web coating/printing or dyeing/finishing operation during the capture efficiency test run, kg.n = Number of different regulated materials applied in the web coating/printing or dyeing/finishing operation during the capture efficiency test run.
