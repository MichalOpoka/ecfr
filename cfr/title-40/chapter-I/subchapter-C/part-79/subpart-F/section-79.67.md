...
(2) *Materials.* The materials necessary to perform this study are [I125] Protein A (2-10 µCi/µg), Anti-sera to GFAP, nitrocellulose paper (0.1 or 0.2 µm pore size), sample application template (optional; e.g., “Minifold II”, Schleicher & Schuell, Keene, NH), plastic sheet incubation trays.
...
(iv) *Sample Preparation.* Dilute tissue samples in sample buffer (120 mM KCl, 20 mM NaCl, 2 mM MgCl2), 5 mM Hepes, pH 7.4, 0.7 percent Triton X-100) to a final concentration of 0.25 mg total protein per ml (5 µg/20 µl).
...
(G) Discard blocking solution and incubate for 1 hour in Protein A solution ([I125]-labeled Protein A diluted in blocking solution containing 0.1 percent Triton X-100, sufficient to produce 2000 counts per minute (cpm) per 10 µl of Protein A solution).
