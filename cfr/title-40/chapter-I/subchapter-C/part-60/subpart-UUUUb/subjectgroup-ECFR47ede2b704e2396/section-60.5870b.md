...
(3) The report must include, for each affected EGU, the sum of the CO2 emissions, the sum of the gross energy output, and the sum of the heat input for each fuel type.
