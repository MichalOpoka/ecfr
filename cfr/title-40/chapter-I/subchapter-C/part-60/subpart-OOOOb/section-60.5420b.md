...
(13) For combustion control devices tested by the manufacturer in accordance with § 60.5413b(d), an electronic copy of the performance test results required by § 60.5413b(d) shall be submitted via email to *Oil\_and\_Gas\_PT@EPA.GOV* unless the test results for that model of combustion control device are posted at the following website: *https://www.epa.gov/controlling-air-pollution-oil-and-natural-gas-industry*.
