...
(c) On and after the date on which the initial performance test is completed or required to be completed under § 60.8, whichever date comes first, no owner or operator subject to the provisions of this subpart shall cause to be discharged into the atmosphere from any affected facility which combusts solid solvent refined coal (SRC-I) any gases that contain SO2 in excess of 520 ng/J (1.20 lb/MMBtu) heat input and 15 percent of the potential combustion concentration (85 percent reduction) except as provided under paragraph (f) of this section; compliance with the emission limitation is determined on a 30-day rolling average basis and compliance with the percent reduction requirement is determined on a 24-hour basis.
...
![](/graphics/er13jn07.008.gif)

(2) If emissions of SO2 to the atmosphere are equal to or less than 260 ng/J (0.60 lb/MMBtu) heat input:

![](/graphics/er13jn07.009.gif)Where:Es = Prorated SO2 emission limit (ng/J heat input);%Ps = Percentage of potential SO2 emission allowed;x = Percentage of total heat input derived from the combustion of liquid or gaseous fuels (excluding solid-derived fuels); andy = Percentage of total heat input derived from the combustion of solid fuel (including solid-derived fuels).
