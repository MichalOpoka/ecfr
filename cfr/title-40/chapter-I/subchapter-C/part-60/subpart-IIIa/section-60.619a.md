...
Equation 1 to Paragraph (j)(7)![](/graphics/er16my24.033.gif)Where:Cm = Average instrument response (ppm)Ca = Certified cylinder gas value (ppm)
...
Equation 2 to Paragraph (k)![](/graphics/er16my24.034.gif)Where:NHVmeasured = Average instrument response (Btu/scf)NHVa = Certified cylinder gas value (Btu/scf)
