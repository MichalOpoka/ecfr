...
![](/graphics/ec01jn92.064.gif)where n is the number of coatings of each type used during each nominal 1-month period and m is the number of different diluent VOC's used during each nominal 1-month period. (Σ Ldj Ddj will be 0 if no VOC's are added to the coatings, as received.)
...
![](/graphics/ec01jn92.065.gif)where n is the number of coatings of each type used during each nominal 1-month period.
...
Equation 3 to Paragraph (b)(2)(i)(D)![](/graphics/er27mr23.002.gif)
...
Equation 4 to Paragraph (b)(2)(i)(E)![](/graphics/er27mr23.003.gif)Where Tavg = T when only one type of coating operation occurs.
