...
E = csQsd/BLSWhere:E = emission rate of filterable particulate matter, g/kg (lb/ton) of BLS.cs = Concentration of filterable particulate matter, g/dscm (lb/dscf).Qsd = volumetric flow rate of effluent gas, dry standard cubic meter per hour (dscm/hr) (dry standard cubic feet per hour (dscf/hr)).BLS = black liquor solids (dry weight) feed rate, kg/hr (ton/hr).
...
GLS = 100CNa2S / (CNa2SCNaOH CNa2CO3)Where:GLS = green liquor sulfidity, percent.CNa2S = concentration of Na2S as Na2O, milligrams per liter (mg/L) (grains per gallon (gr/gal)).CNaOH = concentration of NaOH as Na2O, mg/L (gr/gal).CNa2CO3 = concentration of Na2CO3 as Na2O, mg/L (gr/gal).
...
E = CTRS F Qsd/PWhere:E = emission rate of TRS, g/kg (lb/ton) of BLS or ADP.CTRS = average combined concentration of TRS, ppm.F = conversion factor, 0.001417 g H2S/cubic meter (m3)-ppm (8.846 × 10-8 lb H2S/cubic foot (ft3)-ppm).Qsd = volumetric flow rate of stack gas, dscm/hr (dscf/hr).P = black liquor solids feed or pulp production rate, kg/hr (ton/hr).
