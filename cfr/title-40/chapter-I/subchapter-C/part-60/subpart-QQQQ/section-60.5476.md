...
Immediately after component changes, leak checks are optional but highly recommended. If such leak checks are done, the procedure in paragraph (f)(1) of this section should be used.
