...
![](/graphics/er16ap19.013.gif)Where:X1 = the PM CPMS output data points for the three runs constituting the performance test,Y1 = the PM concentration value for the three runs constituting the performance test, andn = the number of data points.
...
![](/graphics/er16ap19.016.gif)Where:X1 = the PM CPMS data points for all runs i,n = the number of data points, andOh = your site specific operating limit, in milliamps or digital signal equivalent.
...
[84 FR 15884, Apr. 16, 2019, as amended at 85 FR 63406, Oct. 7, 2020]