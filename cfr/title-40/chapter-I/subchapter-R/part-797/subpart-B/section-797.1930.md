...
(4) *Definitive test.* (i) The purpose of the definitive test is to determine the concentration-response curves and the 48- and 96-hour LC50 values with the minimum amount of testing beyond the range-finding test.
