...
(ii) *Definitions and units.* The *UV-VIS absorption spectrum* of a solution is a function of the concentration, c1, expressed in mol/L, of all absorbing species present; the path length, d, of the spectrophotometer cell, expressed in cm; and the molar absorption (extinction) coefficient,εi, of each species. The absorbance (optical density) A of the solution is then given by:

![](/graphics/ec15no91.045.gif)For a resolvable absorbance peak, the band width λ is the wavelength range, expressed in nm = 10−9 m, of the peak at half the absorbance maximum.
...
(*1*) Potassium dichromate (in 0.005 mol/L, H2SO4 solution) from J.A.A. Ketelaar, paragraph (d)(2) of this section:

| log ε |3.56|3.63|3.16|3.50|
|-------|----|----|----|----|
|λ in nm|235 |257 |313 |350 |

(*2*) Fluoranthene (in methanol) from *C.R.C. Atlas of Spectral Data,* paragraph (d)(3) of this section:

| log ε |4.75|4.18|4.73|3.91|3.92|
|-------|----|----|----|----|----|
|λ in nm|237 |236 |288 |339 |357 |
...
![](/graphics/ec15no91.046.gif)where the quantities are as defined above (see Definitions and units).
