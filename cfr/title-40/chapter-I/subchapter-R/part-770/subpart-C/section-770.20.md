...
![](/graphics/er07fe18.001.gif)Where *x* = arithmetic mean; *S* = standard deviation; *n* = number of sets; *D* i = difference between the ASTM E1333-14 and ASTM D6007-14 method (incorporated by reference, see § 770.99) values for the *i* th set; and *i* ranges from 1 to *n.*
...
|*X*| + 0.88*S* ≤ *C*Where *C* is equal to:0.026 for the lower range;0.038 for the intermediate range; and0.052 for the upper range.
...
|Degrees of freedom  <br/>(n-2)|“r” value|
|------------------------------|---------|
|              3               |  0.878  |
|              4               |  0.811  |
|              5               |  0.754  |
