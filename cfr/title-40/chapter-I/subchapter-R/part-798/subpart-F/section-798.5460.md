...
(2) *Description.* Essentially, two methods have been used to screen for translocation heterozygosity; one method uses a mating sequence to identify sterile and semisterile males followed by cytological examination of suspect male individuals; the other method deletes the mating sequence altogether and all F1 male progeny are examined cytologically for presence of translocation. In the former approach, the mating sequence serves as a screen which eliminates most fully fertile animals for cytological confirmation as translocation heterozygotes.
