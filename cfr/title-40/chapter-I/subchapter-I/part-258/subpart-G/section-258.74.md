...
Next Payment = [CE − CV]/Ywhere CE is the current cost estimate for closure or post-closure care (updated for inflation or other changes), CV is the current value of the trust fund, and Y is the number of years remaining in the pay-in period.
