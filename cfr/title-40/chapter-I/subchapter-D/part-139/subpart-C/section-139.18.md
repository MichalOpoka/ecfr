...
|     Discharge water flowrate before any seawater addition for pH control  <br/>(t/MWh)     |Numeric discharge standard  <br/>(µg/L PAHphe equivalents)| Measurement technology  |
|--------------------------------------------------------------------------------------------|----------------------------------------------------------|-------------------------|
|                                            0-1                                             |                          2,250                           |    Ultraviolet light    |
|                                            2.5                                             |                           900                            |         \- ″ -          |
|                                             5                                              |                           450                            |Fluorescence <sup>a</sup>|
|                                           11.25                                            |                           200                            |         \- ″ -          |
|                                            22.5                                            |                           100                            |         \- ″ -          |
|                                             45                                             |                            50                            |         \- ″ -          |
|                                             90                                             |                            25                            |         \- ″ -          |
|<sup>a</sup> For any Flow Rate greater than 2.5 t/MWh, Fluorescence technology must be used.|                                                          |                         |
...
|Discharge water flowrate before any seawater addition for pH control  <br/>(t/MWh)|Numeric discharge standard  <br/>(mg/L nitrate + nitrite)|
|----------------------------------------------------------------------------------|---------------------------------------------------------|
|                                       0-1                                        |                          2,700                          |
|                                       2.5                                        |                          1,080                          |
|                                        5                                         |                           540                           |
