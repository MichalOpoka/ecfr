...
Pm = (0.75−0.433Sg)dwhere:Pm = injection pressure at the wellhead in pounds per square inch Sg = specific gravity of injected fluid (unitless) d = injection depth in feet.Owner/operator of wells shall comply with the above injection pressure limits no later than one year after the effective date of this regulation.
