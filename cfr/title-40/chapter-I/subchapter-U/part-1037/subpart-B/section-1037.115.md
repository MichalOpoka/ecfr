...
![](/graphics/er22ap24.212.gif)Eq. 1037.115-1Where:*UBE* = usable battery energy as determined in paragraph (f)(3) or (4) of this section, where certified refers to the value established for certification and aged refers to the current value as the battery ages.*V* = battery voltage.*t* = the time for the test, running from time zero to the end point when the battery is not able to maintain the target power.*I* = battery current.
