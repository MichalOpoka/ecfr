...
(1) For CFV and SSV testing, *V*mix for each interval of the exhaust test.

(2) For PDP testing, test measurements required to calculate *V*mix for each test interval.
