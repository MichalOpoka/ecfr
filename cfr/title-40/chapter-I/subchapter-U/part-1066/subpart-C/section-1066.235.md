...
![](/graphics/er25oc16.236.gif)Where:*f* = frequency of the dynamometer speed sensing device, accurate to at least four significant figures.*d*roll = nominal roll diameter, accurate to the nearest 1.0 mm, consistent with § 1066.225(d).*n* = the number of pulses per revolution from the dynamometer roll speed sensor.Example:

*f* = 2.9231 Hz = 2.9231 s−1*d*roll = 904.40 mm = 0.90440 m![](/graphics/er25oc16.237.gif)*v*act = 8.3053 m/s
...
![](/graphics/er28ap14.147.gif)Example:*v*act = 8.3053 m/s*v*ref = 8.3000 m/s*v*error = 8.3053 − 8.3000 = 0.0053 m/s
