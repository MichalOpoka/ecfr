...
|Primary intended service class|Power representing accessory load   <br/>(kW)|
|------------------------------|---------------------------------------------|
|          Light HDE           |                     1.5                     |
|          Medium HDE          |                     2.5                     |
|          Heavy HDE           |                     3.5                     |
...
|--------------------------------------------------------------------------------------------------------|-----|-----------------------------|------------------------------|
|                                          Slope, a<sub>1</sub>                                          |     |0.800 ≤ a<sub>1</sub> ≤ 1.030|0.800 ≤ a<sub>1</sub> ≤ 1.030.|
|                              Absolute value of intercept, |a<sub>0</sub>|                              |     |                             |                              |
|                                  Standard error of the estimate, SEE                                   |     |                             |≤15% of maximum mapped power. |
|                         Coefficient of determination, r<sup><sup>2</sup></sup>                         |     |           ≥0.650            |           ≥0.650.            |
