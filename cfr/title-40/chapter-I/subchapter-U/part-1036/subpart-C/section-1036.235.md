...
![](/graphics/er24ja23.013.gif)Where:*i* = an indexing variable that represents one individual weighted duty cycle result for a vehicle configuration.*N* = total number of vehicle configurations.*e*CO2compEPAi = unrounded composite mass of CO2 emissions in g/ton-mile for vehicle configuration *i* for the EPA test.*e*CO2compManui = unrounded composite mass of CO2 emissions in g/ton-mile for vehicle configuration *i* for the manufacturer-declared map.
