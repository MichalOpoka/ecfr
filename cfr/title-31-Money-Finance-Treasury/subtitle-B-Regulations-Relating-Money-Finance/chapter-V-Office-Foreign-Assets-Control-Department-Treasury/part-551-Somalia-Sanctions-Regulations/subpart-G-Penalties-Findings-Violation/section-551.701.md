...
(2) IEEPA provides for a maximum civil penalty not to exceed the greater of $311,562or an amount that is twice the amount of the transaction that is the basis of the violation with respect to which the penalty is imposed.
