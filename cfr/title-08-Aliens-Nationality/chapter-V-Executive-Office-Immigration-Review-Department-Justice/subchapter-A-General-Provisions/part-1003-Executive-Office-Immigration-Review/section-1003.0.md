...
(f) *Citizenship Requirement for Employment.* (1) An application to work at EOIR, either as an employee or a volunteer, must include a signed affirmation from the applicant that he or she is a citizen of the United States of America. If requested, the applicant must document United States citizenship.
