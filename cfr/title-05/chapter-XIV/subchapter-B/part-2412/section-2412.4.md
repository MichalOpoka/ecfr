...
(c) An existence-of-records request must include your name and address and must reasonably describe the system of records in question. Whenever possible, the request should also describe the time periods in which you believe the records were compiled and the name or identifying number of each system of records in which you believe the records are kept. The Authority, the General Counsel, the IG, and the Panel have published descriptions of the systems of records they maintain in the Federal Register.
