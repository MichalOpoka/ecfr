...
(2) Using the tracking number, the requester can find, by calling the Office of the Solicitor, emailing *solmail@flra.gov,* or visiting FOIAXPress (see telephone numbers and addresses at *https://www.flra.gov/foia\_contact*), status information about the request including:
