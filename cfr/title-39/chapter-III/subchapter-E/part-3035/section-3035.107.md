...
*AS*t+1 = *AS*t \* (1 + %Δ*CCM*t−1 + *CGD*t−1)Where,AS = Appropriate Share, expressed as a percentage and rounded to one decimal placeCCM = Competitive Contribution MarginCGD = Competitive Growth Differentialt = Fiscal YearIf t = 0 = FY 2007, AS = 5.5 percent
