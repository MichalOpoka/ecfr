...
(c) *Exception for farming, ranching, and natural resource operations.* The prohibitions in paragraphs (b)(1)(i), (ii), and (iv) of this section shall not apply to a transaction in connection with any farming, ranching, oil and gas, mineral rights, or other natural resource operation in which the member or employee has a financial interest, if he or she is not involved in the decision to engage in, and does not have prior knowledge of, the actual futures, commodity option, or swap transaction and has previously notified the General Counsel 2 in writing of the nature of the operation, the extent of the member's or employee's interest, the types of transactions in which the operation may engage, and the identity of the person or persons who will make trading decisions for the operation; 3 or
...
(1) A transaction entered into by any publicly-available pooled investment vehicle (such as a mutual fund or exchange-traded fund) other than one operated by a person who is a commodity pool operator with respect to such entity if the direct or indirect ownership interest of the member or employee neither exercises control nor has the ability to exercise control over the transactions entered into by such vehicle; 4
