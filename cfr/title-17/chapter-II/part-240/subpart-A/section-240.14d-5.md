...
Reasonably prompt methods of distribution to security holders may be used instead of mailing. If alternative methods are chosen, the approximate direct costs of distribution shall be computed by adding the estimated direct costs of preparing the document for distribution through the chosen medium (including updating of shareholder lists) plus the estimated reasonable cost of distribution through that medium. Direct costs incidental to the distribution of tender offer materials and amendments thereto may include all reasonable charges paid by the subject company to third parties for supplies or services, including costs attendant to preparing shareholder lists, handling the bidder's materials, and contacting participants named on security position listings, but shall not include indirect costs, such as employee time which is devoted to either contesting or supporting the tender offer on behalf of the subject company.

[44 FR 70342, Dec. 6, 1979, as amended at 61 FR 24657, May 15, 1996; 64 FR 61460, Nov. 10, 1999]