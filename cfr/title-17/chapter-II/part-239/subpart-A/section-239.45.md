...
*Instruction to paragraph (a)(1).* The registrant must provide disclosure in a prospectus that is part of the registration statement that it has met the registrant requirements of paragraph (a)(1) of this section.
...
*Instruction to paragraph (b)(1)(iv).* If an underlying transaction agreement contains procedures in order to verify that an investor is, in fact, a beneficial owner for purposes of invoking the investor communication provision, the verification procedures may require no more than the following:
