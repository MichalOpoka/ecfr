...
(b) *Purpose.* The purpose of this section is to provide opportunities for community members and their elected local officials to appeal Postal Service tentative decisions described in paragraphs (a)(1) and (a)(2) of this section and to give input on proposals for implementing those decisions (each a “proposal”), and to require the Postal Service to consider any appeals and input in arriving at final decisions to proceed with, modify, or cancel proposals.
...
(*2*) Identify the site or area, or both, to which the Postal Service anticipates adding the retail service facility;

(*3*) Describe the anticipated size of the added retail service facility, and the anticipated services to be offered; and

(*4*) Outline any anticipated construction (*e.g.,* of a stand-alone building or interior improvements to an existing building (or portion thereof) that will be leased by the Postal Service).
