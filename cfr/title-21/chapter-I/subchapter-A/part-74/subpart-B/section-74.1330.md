...
Volatile matter (at 135 °C), not more than 5 percent.Chlorides and sulfates (calculated as sodium salts), not more than 3 percent.Matter soluble in acetone, not more than 5 percent.Total color, not less than 90 percent.Lead (as Pb), not more than 20 parts per million.Arsenic (as As), not more than 3 parts per million.Mercury (as Hg), not more than 1 part per million.
