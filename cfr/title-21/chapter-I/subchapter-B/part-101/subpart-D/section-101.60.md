...
(A) The identity of the reference food and the percent (or fraction) that the calories differ between the two foods are declared in immediate proximity to the most prominent such claim (e.g., reduced calorie cupcakes “331/3 percent fewer calories than regular cupcakes”); and
