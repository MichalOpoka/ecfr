...
(b) The Food and Drug Administration will publish a notice in the Federal Register stating either that it has accepted, or accepted with modification, as a proposed standard, an existing standard or one that has been developed, or that an existing standard is not acceptable, together with the reasons therefor.
