...
*Direct Federal financial assistance* or *Federal financial assistance provided directly* means that the government or an intermediary (*e.g.,* State, local, or Tribal government, or nongovernmental organization) selects the provider and either purchases services from that provider (*e.g.,* via a contract) or awards funds to that provider to carry out a service (*e.g.,* through a grant or cooperative agreement). In general, Federal financial assistance shall be treated as direct, unless it meets the definition of “indirect Federal financial assistance” or “Federal financial assistance provided indirectly”.
