...
(5) The term *L*eq (8) shall mean the equivalent steady state sound level which in 8 hours would contain the same acoustic energy as the time-varying sound level during the same time period.
