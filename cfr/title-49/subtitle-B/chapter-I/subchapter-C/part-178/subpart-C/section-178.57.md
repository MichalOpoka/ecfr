...
S = [P(1.3D2 + 0.4d2)] / (D2 − d2)where:S = wall stress in pounds psi;P = minimum test pressure prescribed for pressure test in psig;D = outside diameter in inches;d = inside diameter in inches.
...
|Size of specimen|Minimum  <br/>impact value required for avg. of each set of three specimens (ft.-lb.)|Minimum  <br/>impact value permitted on one only of a set of three (ft.-lb.)|
|----------------|-------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
| 10 mm × 10 mm  |                                         15                                          |                                     10                                     |
