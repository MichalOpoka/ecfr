...
(i) Describe the proposed route(s) by State, county, and subdivision, including a plan view, at a scale not to exceed 1:24,000 (71/2 minute U.S.G.S. quadrangle map), clearly showing the relationship to the existing transportation network (including the location of all highway and road crossings) and the right-of-way according to ownership and land use requirements.
