...
(b) Certified applicators shall maintain records of the application of restricted use pesticides made on the same day in a total area of less than one-tenth (1/10) of an acre. Except for applications of restricted use pesticides in greenhouses and nurseries, to which the requirements of paragraph (a) of this section apply, these records shall include the following information for the application:
