...
![](/graphics/ec16se91.024.gif)Where,Cr = The revised interest rate cap;Co = The original interest rate cap at the time of prepayment;Ai = The average interest rate actually charged in the i th period;Ti = Length of the ith period expressed in years;n = The number of years that have elapsed since the initial prepayment;J = The initial term of the private loan, at the time of prepayment;Subject to the constraint that A1 must be less or equal to Co).
