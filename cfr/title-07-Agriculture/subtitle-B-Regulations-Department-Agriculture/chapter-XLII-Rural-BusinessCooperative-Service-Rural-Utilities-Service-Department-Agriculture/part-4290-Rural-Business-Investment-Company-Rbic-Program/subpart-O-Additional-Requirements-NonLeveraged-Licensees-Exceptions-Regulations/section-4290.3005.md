...
(1) For RBICs applying for non-leveraged status, the types of investors eligible to invest in a RBIC must have been approved by the Secretary. Investors seeking approval must submit a request to the Secretary with sufficient documentation to support their request. The USDA will announce such approved categories and types of investors in a public notice published in the Federal Register from time to time. Subsequent notices that modify the types of investors eligible to invest in a RBIC will not be applied retroactively.
...
(b) *Approval of initial Management Expenses.* Section 4290.140 does not apply to Non-leveraged RBICs. However, the Secretary will provide a cap on these expenses in each Federal Register notice soliciting applications for Non-leveraged RBICs.

(c) *Management and ownership diversity requirements.* A Non-leveraged RBIC is subject to the provisions of § 4290.150 unless it is exempted from these provisions by the Secretary. Exemptions will only be granted when the applicant establishes, to the satisfaction of the Secretary, that granting the exemption will not unduly impair the integrity and soundness of the Non-leveraged RBIC.
