...
*Carbon intensity (CI)* means a measure of GHG performance reflecting the estimated quantity of GHG emissions associated with one unit of production. For biofuel feedstock crops, carbon intensity is expressed as grams of carbon dioxide equivalent (CO2-eq) per bushel of produced crop (g CO2-eq/bushel).
