...
(2) The Agency may establish a minimum priority score for each guarantee program. The Agency will, if established, publish the minimum score in a document in the Federal Register. Applications that do not meet the applicable minimum score will compete with all other guaranteed loan applications for each specific program in a competition on the first business day of September of the Federal fiscal year in which the application is ready for funding.
