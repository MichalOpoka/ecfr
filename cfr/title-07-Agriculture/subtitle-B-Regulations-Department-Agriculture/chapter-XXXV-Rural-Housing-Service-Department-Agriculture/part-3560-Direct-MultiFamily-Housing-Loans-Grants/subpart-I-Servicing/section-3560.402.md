...
(b) *Required conversion to PASS.* Borrowers with Daily Interest Accrual System (DIAS) accounts must convert to PASS whenever a loan servicing action on the account involves a change in the loan rates or terms or whenever a subsequent loan to the borrower is closed.
