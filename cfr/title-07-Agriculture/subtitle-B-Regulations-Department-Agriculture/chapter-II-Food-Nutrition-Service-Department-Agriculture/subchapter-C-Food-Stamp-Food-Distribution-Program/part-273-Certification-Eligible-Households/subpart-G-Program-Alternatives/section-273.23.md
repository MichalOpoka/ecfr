...
(h) *Application processing procedures.* (1) The operating agency shall allow project-eligible households to indicate in writing their desire to receive food stamps. Such households shall be notified in writing, at the time such indication is made, that information contained in their TANF, SSI, or Medicaid application will be the basis of their SNAP eligibility determination. If mixed households are included in the project-eligible universe, the project operator shall develop a procedure to collect the necessary information on household members not receiving categorical aid.
