...
(2) The subrecipient is prohibited from using sale proceeds, CCC-provided funds, interest, or program income to acquire goods and services, either directly or indirectly through another party, in a manner that violates country-specific economic sanction programs, as specified in the agreement.
...
(4) In accordance with § 1499.18 and 2 CFR 200.501(h), a description of the applicable compliance requirements and the subrecipient's compliance responsibility. Methods to ensure compliance may include pre-award audits, monitoring during the agreement, and post-award audits.
