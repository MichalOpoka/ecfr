...
(e) A recipient must not use sale proceeds, CCC-provided funds, interest, or program income to acquire goods and services, either directly or indirectly through another party, in a manner that violates a U.S. Government economic sanction program, as specified in the agreement.
...
(2) A recipient must not transfer any funds budgeted for participant support costs, as defined in 2 CFR 200.75, to other categories of expense without the prior approval of CCC.
