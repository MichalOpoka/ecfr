...
(c) A Cooperator shall conduct periodic evaluations of its program and activities and may contract with an independent evaluator to satisfy this requirement. FAS reserves the right to have direct input and control over design, scope, and methodology of any such evaluation, including direct contact with and provision of guidance to the independent evaluator.

(d) A Cooperator shall complete at least one program evaluation each year. Actual scope and timing of the program evaluation shall be determined by the Cooperator and the Division Director and specified in the Cooperator's application approval letter. A program evaluation shall contain:

(1) The name of the party conducting the evaluation;

(2) The activities covered by the evaluation;

(3) A concise statement of the constraint(s) and opportunities and the goals specified in the application;
...
(e) A Cooperator shall submit, via a cover letter to the Division Director, an executive summary which assesses the program evaluation's findings and recommendations and proposes changes in program strategy or design as a result of the evaluation.