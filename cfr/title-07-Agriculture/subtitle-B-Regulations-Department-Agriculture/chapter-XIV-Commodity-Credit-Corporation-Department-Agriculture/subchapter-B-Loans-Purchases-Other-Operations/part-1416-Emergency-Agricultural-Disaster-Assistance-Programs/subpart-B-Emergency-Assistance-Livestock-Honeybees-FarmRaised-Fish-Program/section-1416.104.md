...
(g) For honeybee colony, hive, and feed losses to be eligible, the honeybee colony must meet the following conditions:
...
(h) For fish to be eligible to generate payments under ELAP, the fish must be produced in a controlled environment and the farm-raised fish must:
