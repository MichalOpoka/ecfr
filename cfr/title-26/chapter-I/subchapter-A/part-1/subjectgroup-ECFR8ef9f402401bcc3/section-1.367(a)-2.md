...
Example.X, a domestic corporation, and Y, a foreign corporation not related to X, transfer property to Z, a newly formed foreign corporation organized for the purpose of combining the research activities of X and Y. Z contracts all of its operational and research activities to Y for an arm's-length fee. Z's activities do not constitute the active conduct of a trade or business.
