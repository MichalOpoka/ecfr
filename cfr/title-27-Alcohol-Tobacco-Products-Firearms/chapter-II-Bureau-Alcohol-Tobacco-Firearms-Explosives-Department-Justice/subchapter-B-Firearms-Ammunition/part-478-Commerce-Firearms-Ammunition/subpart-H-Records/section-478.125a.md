...
|----------------------------------|-----------|----------|----|----------------|----|-----------------------------------------------|----------------------------|
|Manufacturer and importer (if any)|   Model   |Serial No.|Type|Caliber or gauge|Date|Name and address (business address if licensee)|Date of birth if nonlicensee|
|                                  |           |          |    |                |    |                                               |                            |
