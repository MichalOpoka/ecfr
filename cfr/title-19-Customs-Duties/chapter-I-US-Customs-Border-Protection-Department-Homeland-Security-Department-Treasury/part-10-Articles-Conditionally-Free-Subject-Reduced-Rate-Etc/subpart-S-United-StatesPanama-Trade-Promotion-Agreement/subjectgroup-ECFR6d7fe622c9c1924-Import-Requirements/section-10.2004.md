...
(a) *General.* An importer who makes a claim pursuant to § 10.2003(b) based on a certification by the importer, exporter, or producer that the good is originating must submit, at the request of the port director, a copy of the certification. The certification:
