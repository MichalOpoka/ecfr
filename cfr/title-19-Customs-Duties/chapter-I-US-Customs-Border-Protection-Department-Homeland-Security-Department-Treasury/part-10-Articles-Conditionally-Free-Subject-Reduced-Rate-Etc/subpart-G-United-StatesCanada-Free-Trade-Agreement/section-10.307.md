...
(e) *Exceptions to documentation requirements.* Exceptions to the foregoing documentation requirements may be authorized at the discretion of the port director in the following circumstances:
...
( ) Manufacturer( ) Supplier( ) ExporterSignatureTitleDate:
