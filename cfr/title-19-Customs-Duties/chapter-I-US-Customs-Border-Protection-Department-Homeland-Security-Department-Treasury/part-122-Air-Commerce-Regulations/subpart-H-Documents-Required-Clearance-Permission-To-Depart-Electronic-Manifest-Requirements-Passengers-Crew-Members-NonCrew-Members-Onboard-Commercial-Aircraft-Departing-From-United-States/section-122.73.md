...
(b) *Air cargo manifest* - (1) *Form.* The air cargo manifest must be on CBP Form 7509, and shall show all information required. If a general declaration is not presented, the following statement, signed by the aircraft commander or agent, must appear on the form:
