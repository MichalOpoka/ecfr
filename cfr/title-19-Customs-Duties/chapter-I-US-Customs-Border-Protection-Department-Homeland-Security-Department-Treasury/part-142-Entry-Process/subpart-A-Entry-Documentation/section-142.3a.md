...
XXX-NNNNNNN-NXXX represents an entry filer code assigned by CBP, NNNNNNN is a unique number which is assigned by the broker or importer, and N is a check digit computed from the first 10 characters based on a formula provided by CBP.
