...
(f) *Low-value licenses.* There is one exception to the requirement for obtaining a unique license for each Customs entry. If the total value of the covered steel portion of an entry is less than $250, applicants may apply to Commerce for a low-value license that can be used in lieu of a single entry license for low-value entries.