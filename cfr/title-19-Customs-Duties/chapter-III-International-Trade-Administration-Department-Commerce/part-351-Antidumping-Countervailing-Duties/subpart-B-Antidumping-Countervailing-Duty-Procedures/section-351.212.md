...
(c) *Automatic assessment of antidumping and countervailing duties if no review is requested.* (1) If the Secretary does not receive a timely request for an administrative review of an order (*see* paragraph (b)(1), (b)(2), or (b)(3) of § 351.213), the Secretary, without additional notice, will instruct the Customs Service to:
