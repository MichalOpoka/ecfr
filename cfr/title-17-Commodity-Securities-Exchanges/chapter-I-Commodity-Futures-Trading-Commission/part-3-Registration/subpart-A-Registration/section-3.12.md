...
(iv) Engaged in any activity as an associated person, as defined in § 1.3(aa) of this chapter, from a location outside the United States, its territories or possessions, and limits such activities to customers located outside the United States, its territories or possessions.
...
(Approved by the Office of Management and Budget under control number 3038-0023)[45 FR 80491, Dec. 5, 1980]Editorial Note:For Federal Register citations affecting § 3.12, see the List of CFR Sections Affected, which appears in the Finding Aids section of the printed volume and at *www.fdsys.gov.*