...
(n) *Grandfathered no-action letters.* Any non-narrow based security index futures contract that is the subject of an existing no-action letter issued by the Office of General Counsel, as of the date of the adoption of rule 30.13, shall be deemed to be in conformance with the criteria of section 2(a)(1)(C)(ii) of the Act, provided that the foreign board of trade submits a written statement representing that the contract remains fully compliant with the requirements of such letter.
