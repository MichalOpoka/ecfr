...
(a) *Real-time public reporting of swap transaction and pricing data.* Each swap dealer and major swap participant shall report all information and swap transaction and pricing data required to be reported in accordance with the real-time public recording requirements in part 43 of this chapter.
