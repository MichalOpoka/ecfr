...
(l) *Additional position and counterparty reporting requirements.* A swap dealer or major swap participant must provide on a monthly basis to the Commission and to the registered futures association of which the swap dealer or major swap participant is a member the specific information required in Appendix B to Subpart E of this part.
