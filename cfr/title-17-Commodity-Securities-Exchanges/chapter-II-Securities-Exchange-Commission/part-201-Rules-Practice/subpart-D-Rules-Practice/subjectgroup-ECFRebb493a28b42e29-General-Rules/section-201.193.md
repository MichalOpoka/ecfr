...
(a) *Scope of rule.* Applications for Commission consent to associate, or to change the terms and conditions of association, with a registered broker, dealer, municipal securities dealer, government securities broker, government securities dealer, investment adviser, investment company or transfer agent may be made pursuant to this section where a Commission order bars the individual from association with a registered entity and:
...
(b) *Form of application.* Each application shall be supported by an affidavit, manually signed by the applicant, that addresses the factors set forth in paragraph (d) of this section. One original and three copies of the application shall be filed pursuant to §§ 201.151, 201.152 and 201.153. Each application shall include as exhibits:
...
(d) *Factors to be addressed.* The affidavit required by paragraph (b) of this section shall address each of the following:
...
(f) *Concurrent applications.* The Commission will not consider any application submitted pursuant to this section if any other application for consent to associate concerning the same applicant is pending before any self-regulatory organization.