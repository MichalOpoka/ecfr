...
(c) *Intermarket sweep orders.* The trading center, broker, or dealer responsible for the routing of an intermarket sweep order shall take reasonable steps to establish that such order meets the requirements set forth in § 242.600(b)(31).
