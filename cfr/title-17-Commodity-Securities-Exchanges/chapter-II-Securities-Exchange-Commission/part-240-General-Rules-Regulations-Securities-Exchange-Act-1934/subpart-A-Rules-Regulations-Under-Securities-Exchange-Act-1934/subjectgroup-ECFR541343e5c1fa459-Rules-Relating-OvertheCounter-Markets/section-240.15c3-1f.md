...
(§ 240.15c3-1a). In this computation, the OTC derivatives dealer may use its own theoretical pricing model provided that it contains the minimum pricing factors set forth in appendix A.
