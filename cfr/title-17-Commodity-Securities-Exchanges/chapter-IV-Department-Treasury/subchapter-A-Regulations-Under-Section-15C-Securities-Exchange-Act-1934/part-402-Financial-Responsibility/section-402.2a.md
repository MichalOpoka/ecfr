...
b. Enter the Total Futures and Options Offset Haircut from column 19 of Schedule D.

c. Enter the Total Hedging Disallowance Haircut as calculated in Schedule E, column 27.

d. Enter the Residual Net Position Haircut as given in column 28 of Schedule E.
...
(2) Zero-coupon receipts or certificates based on marketable Treasury notes or bonds;

(3) Marketable certificates of deposit of no more than one year to maturity;
...
Since the net residual position interim haircut in any category containing a hedging disallowance haircut is zero, further netting with any such category is impossible.
