...
(2) *Potency Test.* An in vitro potency test shall be conducted. To be eligible for release, each serial and subserial shall have a virus titer sufficiently greater than the titer of vaccine virus used in the immunogenicity test prescribed in paragraph (c) of this section to assure that, when tested at any time within the expiration period, each serial and subserial shall have a virus titer 10 0.7 greater than that used in such immunogenicity test when tested by the method used in paragraph (c)(2) of this section.
