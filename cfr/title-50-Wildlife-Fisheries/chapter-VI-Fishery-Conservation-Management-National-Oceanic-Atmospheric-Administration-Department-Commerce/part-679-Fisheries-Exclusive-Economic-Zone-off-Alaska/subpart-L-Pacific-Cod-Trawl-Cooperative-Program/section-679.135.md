...
100 × DPC/Vwhere:DPC = the direct program costs for the PCTC Program for the previous calendar year with any adjustments to the account from payments received in the previous year.V = total of the standard ex-vessel value of the catch subject to the PCTC cost recovery fee liability for the current year.
