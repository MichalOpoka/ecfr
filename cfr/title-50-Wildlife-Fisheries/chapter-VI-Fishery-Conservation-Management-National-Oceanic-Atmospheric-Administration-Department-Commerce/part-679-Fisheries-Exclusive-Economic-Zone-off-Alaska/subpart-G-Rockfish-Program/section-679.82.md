...
(iii) Upon determining that a halibut PSC sideboard limit is or will be reached, the Regional Administrator will publish notification in the Federal Register prohibiting directed fishing for the rockfish sideboard fishery in the regulatory area or district for catcher/processor opt-out vessels that will be effective from July 1 through July 31.
...
(iii) Upon determining that a halibut PSC sideboard limit is or will be reached, the Regional Administrator will publish notification in the Federal Register prohibiting directed fishing for the species or species in that complex for catcher/processors opt-out vessels that will be effective from July 1 through July 31. The following specific directed fishing closures will be implemented if a halibut PSC sideboard limit is reached:
