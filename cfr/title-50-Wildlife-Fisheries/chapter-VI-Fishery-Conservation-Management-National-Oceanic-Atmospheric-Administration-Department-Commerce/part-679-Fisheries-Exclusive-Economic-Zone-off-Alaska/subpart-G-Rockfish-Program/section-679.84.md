...
(1) *Catch weighing.* All catch is weighed on a NMFS-approved scale in compliance with the scale requirements at § 679.28(b). Each haul must be weighed separately and all catch must be made available for sampling by an observer.
