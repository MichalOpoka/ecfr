...
(c) *Exceptions.* The Regional Administrator is not required to specify an annual catch limit for a management unit species that is statutorily excepted from the requirement pursuant to 50 CFR 600.310(h)(2), or that the Council has identified as an ecosystem component species. The Regional Administrator will publish in the Federal Register the list of ecosystem component species, and will publish any changes to the list, as necessary.
