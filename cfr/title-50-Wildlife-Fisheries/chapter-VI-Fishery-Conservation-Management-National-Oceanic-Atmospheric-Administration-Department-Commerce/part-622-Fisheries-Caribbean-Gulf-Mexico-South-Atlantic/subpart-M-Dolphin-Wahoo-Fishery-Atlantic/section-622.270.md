...
(c) *Operator permits.* (1) An operator of a vessel that has or is required to have a charter vessel/headboat or commercial permit for Atlantic dolphin and wahoo issued under this section is required to have an operator permit.

(2) A person required to have an operator permit under paragraph (c)(1) of this section must carry on board such permit and one other form of personal identification that includes a picture (driver's license, passport, etc.).

(3) An owner of a vessel that is required to have a permitted operator under paragraph (c)(1) of this section must ensure that at least one person with a valid operator permit is aboard while the vessel is at sea or offloading.

(4) An owner of a vessel that is required to have a permitted operator under paragraph (c)(1) of this section and the operator of such vessel are responsible for ensuring that a person whose operator permit is suspended, revoked, or modified pursuant to subpart D of 15 CFR part 904 is not aboard that vessel.
