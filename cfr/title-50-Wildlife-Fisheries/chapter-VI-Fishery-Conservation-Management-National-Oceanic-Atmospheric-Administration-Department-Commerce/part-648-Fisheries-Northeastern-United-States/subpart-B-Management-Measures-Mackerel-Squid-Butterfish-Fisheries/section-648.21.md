...
(c) *Most restrictive ABC recommendation.* (1) Unless otherwise allowed in paragraph (c)(2) of this section, for instances in which the application of the risk policy approaches in paragraph (b) of this section using OFL distribution results in a more restrictive ABC recommendation than the calculation of ABC derived from the use of FREBUILD at the MAFMC-specified overfishing risk level as outlined in paragraph (a) of this section, the SSC shall recommend to the MAFMC the lower of the ABC values.
