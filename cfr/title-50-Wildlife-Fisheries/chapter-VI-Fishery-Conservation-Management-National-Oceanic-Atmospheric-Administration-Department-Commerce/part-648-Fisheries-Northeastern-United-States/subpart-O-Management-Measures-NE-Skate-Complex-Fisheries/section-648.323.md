...
(b) *ACL overages* - (1) If the ACL is determined to have been exceeded in any given year, based upon, but not limited to, available landings and discard information, the percent buffer between ACL and ACT, initially specified at 25 percent, shall be increased by 1 percent for each 1-percent ACL overage in the second fishing year following the fishing year in which the ACL overage occurred, through either the specifications or framework adjustment process described under §§ 648.320 and 648.321.
