...
(iii) *LAGC vessels fishing NGOM.* LAGC IFQ and NGOM vessel owners, operators, or managers must notify the NMFS by telephone by 0001 hr of the Thursday preceding the week (Sunday through Saturday) that they intend to start a NGOM scallop trip and must include the port of departure. NMFS may select up to two trips to be covered by an observer during the specified week (Sun-Sat). The owner, operator, or vessel manager must notify NMFS of any trip plan changes at least 48 hr prior to vessel departure.
