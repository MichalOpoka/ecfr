...
A = 0.1(D) square inches.A = 6.94(D) square centimeters.Where—A = the combined area of the scuppers in square inches (square centimeters).D = the area of the cockpit in square feet (square meters).
