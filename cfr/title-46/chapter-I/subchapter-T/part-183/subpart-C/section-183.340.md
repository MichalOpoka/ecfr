...
![](/graphics/er10ja96.010.gif)Where:cm = Circular-mil area of conductorK = 3.28 ohms/mil-meter (metric) = 10.75 ohm/mil-foot (english)(a constant representing the resistance of copper).I = Load current, in amperes.L = length of conductor from center of distribution, in meters (feet).E = Voltage drop at load, in volts.
