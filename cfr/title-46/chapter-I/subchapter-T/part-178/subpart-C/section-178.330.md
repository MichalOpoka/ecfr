...
Total Test Weight (W) = \_\_\_\_\_\_\_\_Passenger Capacity of Upper Deck:Weight on Upper Deck = (Number of Passengers on Upper Deck) \* (Wt per Passenger) \* 1.33Weight on Main Deck = Total Test Weight−Weight on Upper Deck.
...
i = f(2L−L′)/4Lwhere:i = maximum allowable immersion in meters (feet);f = freeboard in meters (feet);L = length of the weather deck, in meters (feet); andL′ = length of cockpit in meters (feet).
