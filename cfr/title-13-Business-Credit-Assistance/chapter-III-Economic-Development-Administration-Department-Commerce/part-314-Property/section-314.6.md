...
(3) *Pre-existing encumbrances.* Encumbrances already in place at the time EDA approves the Project where EDA determines that the requirements of § 314.7(b) of this chapter are met.
...
(B) The non-profit organization is financially strong and is an established organization with sufficient organizational life to demonstrate stability over time;
