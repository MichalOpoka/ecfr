...
(2) *Total Set-aside of Multiple Award Contracts.* (i) The contracting officer must conduct market research to determine whether the “rule of two” can be met. If the “rule of two” can be met, the contracting officer must follow the procedures for a set-aside set forth in paragraph (f) of this section.
