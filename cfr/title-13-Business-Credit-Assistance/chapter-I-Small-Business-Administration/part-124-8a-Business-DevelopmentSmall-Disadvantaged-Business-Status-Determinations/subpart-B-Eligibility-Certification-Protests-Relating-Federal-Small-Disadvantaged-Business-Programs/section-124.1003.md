...
(c) A procuring agency may accept a certification from another entity (*e.g.*, a private certifying entity, or a state or local government) that a firm qualifies as an SDB if the agency deems it appropriate.
