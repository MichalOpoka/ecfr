...
(g) *Cooperative care.* Medical services and supplies for which CHAMPUS will share in the cost under circumstances specified in § 728.4(z), even though the patient remains under the primary control of a USMTF.
...
(2) Retired members as defined in § 728.2(bb).
