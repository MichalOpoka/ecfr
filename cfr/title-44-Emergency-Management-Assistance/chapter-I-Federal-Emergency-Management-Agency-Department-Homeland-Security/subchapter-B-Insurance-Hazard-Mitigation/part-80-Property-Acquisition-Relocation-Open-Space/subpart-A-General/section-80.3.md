...
(c) *Grantee* means the State or Indian tribal government to which FEMA awards a grant and which is accountable for the use of the funds provided. The grantee is the entire legal entity, even if only a particular component of the entity is designated in the grant award document.
...
(e) *National of the United States* means a person within the meaning of the term as defined in the Immigration and Nationality Act, 8 U.S.C. section 1101(a)(22).

(f) *Purchase offer* is the initial value assigned to the property, which is later adjusted by applicable additions and deductions, resulting in a final offer amount to a property owner.
