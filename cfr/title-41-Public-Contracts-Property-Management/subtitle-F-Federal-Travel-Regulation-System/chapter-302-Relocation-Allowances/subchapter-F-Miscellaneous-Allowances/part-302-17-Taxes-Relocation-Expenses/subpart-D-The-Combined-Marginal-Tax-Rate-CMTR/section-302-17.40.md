...
CMTR = F + (1-F)S + (1-F)LWhere:F = Your Federal marginal tax rateS = Your state marginal tax rate, if anyL = Your local marginal tax rate, if anyExample 2 to part 302-17:Calculating the Combined Marginal Tax RateFederal marginal tax rate - 33%State marginal tax rate - 6%Local marginal tax rate - 3%CMTR = 0.33 + (1.00 − 0.33)(.06) + (1.00 − 0.33)(0.03) = .3903 or 39.03%
